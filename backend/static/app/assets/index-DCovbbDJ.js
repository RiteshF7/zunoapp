(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function n(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(o){if(o.ep)return;o.ep=!0;const s=n(o);fetch(o.href,s)}})();function mt(){const e=localStorage.getItem("zuno_theme")||"system";ve(e),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{(localStorage.getItem("zuno_theme")||"system")==="system"&&ve("system")})}function ve(e){localStorage.setItem("zuno_theme",e);const t=e==="dark"||e==="system"&&window.matchMedia("(prefers-color-scheme: dark)").matches;document.documentElement.classList.toggle("dark",t)}function pt(){return localStorage.getItem("zuno_theme")||"system"}window.applyTheme=ve;const Ze=typeof import.meta<"u"&&"https://orpdwhqgcthwjnbirizx.supabase.co"||typeof import.meta<"u"&&!1||"",ft=typeof import.meta<"u"&&"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ycGR3aHFnY3Rod2puYmlyaXp4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzA3MjUxMjAsImV4cCI6MjA4NjMwMTEyMH0.4RMhxpB6tTSDEKQfubST_TzPhsvx2Z1HT2juHZDD7qM"||typeof import.meta<"u"&&!1||"",gt="com.zuno.app",bt=`${gt}://callback`;function de(){return!!(window.Capacitor&&window.Capacitor.isNativePlatform&&window.Capacitor.isNativePlatform())}function Se(){var n,a,o,s;const e=typeof window<"u"&&((n=window.location)==null?void 0:n.hostname);return(e==="localhost"||e==="127.0.0.1")&&typeof window<"u"&&((a=window.location)!=null&&a.origin)?window.location.origin:e==="localhost"&&!((o=window.location)!=null&&o.port)?"http://10.0.2.2:8000":typeof import.meta<"u"&&"https://zunoapp.onrender.com"||typeof window<"u"&&window.ZUNO_API_BASE||typeof window<"u"&&((s=window.location)==null?void 0:s.origin)||""}function xt(){return!1}function ht(){return de()?bt:window.location.origin+window.location.pathname}function Je(){var a,o,s;if(typeof window>"u"||!((a=window.Capacitor)!=null&&a.getPlatform)||window.Capacitor.getPlatform()!=="ios")return;const e=localStorage.getItem("zuno_token");if(!e)return;const t=Se(),n=(s=(o=window.Capacitor)==null?void 0:o.Plugins)==null?void 0:s.ZunoAuthSync;n!=null&&n.syncToken&&n.syncToken({token:e,apiBase:t}).catch(()=>{})}function E(e){window.location.hash=e}function C(e){const t=e.startsWith("#")?e:"#"+e,n=new URL(window.location.href);n.hash=t,history.replaceState(null,"",n)}const vt=new Set(["auth","connect-extension","home","library","feed","collections","content-detail","collection","goals","goal-detail","search","knowledge","profile","admin"]);function yt(){const t=(window.location.hash||"").replace(/^#/,"").split("/"),n=(t[0]||"").trim().toLowerCase(),a=(t[1]||"").trim()||null;return{page:n&&vt.has(n)?n:"",id:a}}window.navigate=E;const wt="modulepreload",kt=function(e){return"/app/"+e},je={},ce=function(t,n,a){let o=Promise.resolve();if(n&&n.length>0){let i=function(m){return Promise.all(m.map(g=>Promise.resolve(g).then(l=>({status:"fulfilled",value:l}),l=>({status:"rejected",reason:l}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),c=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));o=i(n.map(m=>{if(m=kt(m),m in je)return;je[m]=!0;const g=m.endsWith(".css"),l=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${l}`))return;const f=document.createElement("link");if(f.rel=g?"stylesheet":wt,g||(f.as="script"),f.crossOrigin="",f.href=m,c&&f.setAttribute("nonce",c),document.head.appendChild(f),g)return new Promise((v,b)=>{f.addEventListener("load",v),f.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${m}`)))})}))}function s(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return o.then(i=>{for(const r of i||[])r.status==="rejected"&&s(r.reason);return t().catch(s)})};let V=null;function $t(e){return e.startsWith("/api/")&&!e.startsWith("/api/v1/")?"/api/v1"+e.slice(4):e}async function Ge(e,t,n,a){const o=localStorage.getItem("zuno_token"),s={};o&&(s.Authorization=`Bearer ${o}`);const i=$t(t);let c=`${Se()}${i}`;if(a){const v=new URLSearchParams;Object.entries(a).forEach(([_,h])=>{h!==""&&h!=null&&v.append(_,h)});const b=v.toString();b&&(c+="?"+b)}const m={method:e,headers:s};n&&["POST","PATCH","PUT","DELETE"].includes(e)&&(s["Content-Type"]="application/json",m.body=JSON.stringify(n));const g=await fetch(c,m),l=await g.text();let f;try{f=JSON.parse(l)}catch{f=l}return{ok:g.ok,status:g.status,data:f}}async function u(e,t,n=null,a=null){typeof window.showProgress=="function"&&window.showProgress();try{let o=await Ge(e,t,n,a);if(o.status===401&&(!!localStorage.getItem("zuno_refresh_token")&&await _t()&&(o=await Ge(e,t,n,a)),o.status===401)){const r=window.location.hash||"#";if(r!=="#auth"&&r!=="#")try{sessionStorage.setItem("zuno_intended_route",r)}catch{}localStorage.removeItem("zuno_token"),localStorage.removeItem("zuno_refresh_token"),window.location.hash!=="#auth"&&(window.location.hash="#auth")}return o}catch(o){return{ok:!1,status:0,data:{error:o.message}}}finally{typeof window.hideProgress=="function"&&window.hideProgress()}}async function _t(){return V||(V=(async()=>{try{const{refreshAccessToken:e}=await ce(async()=>{const{refreshAccessToken:t}=await Promise.resolve().then(()=>Gt);return{refreshAccessToken:t}},void 0);return await e()}catch{return!1}finally{V=null}})(),V)}let A=null;function Ce(e){A=e}function Re(e){const t=document.querySelector("#topnav .header-profile-btn"),n=document.getElementById("header-profile-avatar");!t||!n||(e?(n.style.backgroundImage=`url(${encodeURI(e)})`,n.classList.remove("hidden"),t.classList.add("has-avatar")):(n.style.backgroundImage="",n.classList.add("hidden"),t.classList.remove("has-avatar")))}async function St(e=!1){if(A&&!e)return Re(A.avatar_url||null),A;const t=await u("GET","/api/profile");return t.ok&&(A=t.data),Re((A==null?void 0:A.avatar_url)||null),A||{}}let ue="saved";function Ye(e){ue=e}let ie="summary";function Te(e){ie=e}let R="active";function Ct(e){R=e}let D=!1;function Tt(e){D=e}let le=!1;function Et(e){le=e}let U="fts";function Lt(e){U=e}let Y=[];function De(e){Y.push(e)}function Pt(){Y=[]}const At=["What topics appear most in my saved content?","Summarize my most recent saves","What are the key takeaways from my articles?","How are my saved items connected?"];let se=null;function It(e){se=e}const me=new Set;function Qe(e){me.add(e)}function I(e){me.delete(e)}function q(){return me}function Mt(e){return me.has(e)}function Z(e=3){return Array(e).fill(0).map(()=>`
    ...
    </div>`}function Oe(){return'<div class="flex justify-center py-12"><div class="spinner"></div></div>'}function d(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}function Ee(e,t=100){return e&&e.length>t?e.slice(0,t)+"...":e||""}function Bt(){const e=new Date().getHours();return e<12?"Good morning":e<18?"Good afternoon":"Good evening"}function p(e,t=!1){const n=document.getElementById("toast");n.querySelector(".toast-msg").textContent=e;const a=n.querySelector(".toast-icon");a.textContent=t?"error_outline":"check_circle",a.className=`toast-icon material-icons-round text-lg ${t?"text-danger":"text-success"}`,n.classList.remove("hidden"),clearTimeout(n._t),n._t=setTimeout(()=>n.classList.add("hidden"),3e3)}window.toast=p;function F(e){if(e.ok)return;const t=e.data;let n="Something went wrong";t&&typeof t=="object"?typeof t.error=="string"?n=t.error:t.detail!=null&&(typeof t.detail=="string"?n=t.detail:Array.isArray(t.detail)&&(n=t.detail.map(a=>a.msg||a.message||JSON.stringify(a)).join("; ")||n)):typeof t=="string"&&t&&(n=t),p(n,!0)}function Xe(e){e.innerHTML=`
    ...
    </div>`}async function Ht(){const e=ht(),t=`${Ze}/auth/v1/authorize?provider=google&redirect_to=${encodeURIComponent(e)}`;if(de())try{const{Browser:n}=await ce(async()=>{const{Browser:a}=await import("./index-CM0HNuo9.js");return{Browser:a}},[]);await n.open({url:t,windowName:"_system"})}catch{window.open(t,"_system")}else window.location.href=t}async function Le(e){let t;if(e){const r=e.indexOf("#");t=r>=0?e.substring(r+1):""}else{const r=window.location.hash;t=r?r.substring(1):""}if(t&&t.includes("error=")){const r=new URLSearchParams(t),c=r.get("error")||"unknown",m=r.get("error_description")||r.get("error_description")||c,g=`${c}: ${decodeURIComponent(String(m).replace(/\+/g," "))}`;return console.error("[OAuth]",g),p(g,!0),history.replaceState(null,"",window.location.pathname+"#auth"),!1}if(!t||!t.includes("access_token="))return!1;const n=new URLSearchParams(t),a=n.get("access_token"),o=n.get("refresh_token");if(!a)return!1;if(localStorage.setItem("zuno_token",a),o&&localStorage.setItem("zuno_refresh_token",o),de())try{const{Browser:r}=await ce(async()=>{const{Browser:c}=await import("./index-CM0HNuo9.js");return{Browser:c}},[]);await r.close()}catch{}let s="#home";try{const r=sessionStorage.getItem("zuno_intended_route");r&&r.startsWith("#")&&(s=r,sessionStorage.removeItem("zuno_intended_route"))}catch{}history.replaceState(null,"",window.location.pathname+s);const i=await u("GET","/api/profile");return i.ok?(Ce(i.data),Je(),p("Signed in as "+(i.data.display_name||i.data.email||"user")),!0):(localStorage.removeItem("zuno_token"),localStorage.removeItem("zuno_refresh_token"),history.replaceState(null,"",window.location.pathname+"#auth"),F(i),!1)}async function jt(){const e=localStorage.getItem("zuno_refresh_token");if(!e)return!1;try{const t=await fetch(`${Ze}/auth/v1/token?grant_type=refresh_token`,{method:"POST",headers:{"Content-Type":"application/json",apikey:ft},body:JSON.stringify({refresh_token:e})});if(!t.ok)return!1;const n=await t.json();return n.access_token?(localStorage.setItem("zuno_token",n.access_token),n.refresh_token&&localStorage.setItem("zuno_refresh_token",n.refresh_token),!0):!1}catch{return!1}}function et(){localStorage.removeItem("zuno_token"),localStorage.removeItem("zuno_refresh_token"),Ce(null),E("#auth"),p("Signed out")}window.doLogout=et;window.doGoogleLogin=Ht;const Gt=Object.freeze(Object.defineProperty({__proto__:null,doLogout:et,handleOAuthCallback:Le,refreshAccessToken:jt,renderAuth:Xe},Symbol.toStringTag,{value:"Module"}));function O(e,t="indigo"){return e?`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-semibold bg-${t}-500/15 text-${t}-600 dark:text-${t}-400">${d(e)}</span>`:""}function ye(e){return{youtube:"play_circle",instagram:"camera_alt",x:"tag",reddit:"forum",tiktok:"music_note",spotify:"headphones",web:"language"}[e]||"link"}function Q(e,t={}){const n=e.content_id||e.id,a=e.title||e.url||"Untitled",o=e.description||e.ai_summary||"",s=e.image_url||e.thumbnail_url,i=e.category||e.ai_category,r=e.platform,c=t.showBookmark||!1,m=t.isBookmarked||!1,g=t.showAiStatus||!1,l=t.processingIds||null,f=e.ai_processed,v=g&&l&&l.has(n),b=t.roundedMinimal||!1,_=b?"rounded-md":"rounded-2xl",h=b?"rounded":"rounded-xl",y=g?v?`<span class="text-accent/80 text-[10px] flex items-center gap-1 shrink-0" role="status" aria-busy="true">
    ...
    <article class="bg-card ${_} p-4 border border-border shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer active:scale-[0.97] group"
      ...
      <div class="flex gap-3">
        ${s?`<img src="${d(s)}" alt="" class="w-20 h-20 ${h} object-cover flex-shrink-0" onerror="this.style.display='none'" loading="lazy"/>`:`<div class="w-20 h-20 ${h} bg-surface-hover flex items-center justify-center flex-shrink-0"><span class="material-icons-round text-2xl text-muted-foreground">${ye(r)}</span></div>`}
          ...
          <div class="flex items-start justify-between gap-2">
            ...
            ${c?`
              <button class="card-action flex-shrink-0 p-1 rounded-lg hover:bg-surface-hover transition-colors" onclick="toggleBookmark('${e.id}', this)" aria-label="${m?"Remove bookmark":"Add bookmark"}">
                <span class="material-icons-round text-lg ${m?"text-accent bookmark-pop":"text-muted-foreground"}">${m?"bookmark":"bookmark_border"}</span>
              </button>`:""}
          </div>
          <p class="text-muted-foreground text-xs mt-1 line-clamp-2">${d(Ee(o,120))}</p>
          <div class="flex items-center gap-2 mt-2 flex-wrap">
            ${O(i)}
            ${r?`<span class="text-muted-foreground text-[10px] flex items-center gap-0.5"><span class="material-icons-round text-xs">${ye(r)}</span>${d(r)}</span>`:""}
            ${y}
          </div>
        </div>
      </div>
    </article>`}function tt(e,t=48,n=4,a="var(--c-accent)"){const o=(t-n)/2,s=2*Math.PI*o,i=s-s*e/100;return`<svg width="${t}" height="${t}" viewBox="0 0 ${t} ${t}" class="transform -rotate-90">
  ...
  </svg>`}async function Rt(e){await u("PATCH","/api/user-preferences",{feed_type:e}),await k()}async function Dt(e,t){var a;const n=await u("POST",`/api/feed/bookmarks/${e}/toggle`);if(n.ok){const o=t.querySelector("span"),s=((a=n.data)==null?void 0:a.bookmarked)??!o.textContent.includes("border");o.textContent=s?"bookmark":"bookmark_border",o.classList.toggle("text-accent",s),o.classList.toggle("text-muted-foreground",!s),s?o.classList.add("bookmark-pop"):o.classList.remove("bookmark-pop")}}window.switchFeedType=Rt;window.toggleBookmark=Dt;const Ot=15,Fe=15,Ue={blue:"from-blue-500/20 to-blue-600/5 border-blue-500/20",green:"from-green-500/20 to-green-600/5 border-green-500/20",purple:"from-purple-500/20 to-purple-600/5 border-purple-500/20",amber:"from-amber-500/20 to-amber-600/5 border-amber-500/20",rose:"from-rose-500/20 to-rose-600/5 border-rose-500/20",indigo:"from-indigo-500/20 to-indigo-600/5 border-indigo-500/20"};function Ft(e){const t=Ue[e.theme]||Ue.blue;return`
    ...
    </article>`}async function Ut(e){const[t,n,a]=await Promise.all([St(),u("GET","/api/collections"),u("GET","/api/content",null,{limit:Fe})]);n.ok||F(n),a.ok||F(a);const o=(t==null?void 0:t.display_name)||"there",i=(n.ok?Array.isArray(n.data)?n.data:[]:[]).slice(0,Ot),r=a.ok?a.data:null,m=(Array.isArray(r)?r:(r==null?void 0:r.items)??[]).slice(0,Fe),g=`
    <section class="mb-4" aria-label="Welcome">
      <h1 class="text-xl font-bold text-heading">Hi, ${d(o)}!</h1>
      <p class="text-muted-foreground text-sm mt-0.5">${Bt()}</p>
    </section>`,l=`
    ...
    <div class="space-y-3 max-h-[50vh] overflow-y-auto pr-1" id="home-library-list">
      ${m.map(_=>Q(_,{showAiStatus:!0,processingIds:q(),roundedMinimal:!0})).join("")}
    ...
    <div class="fade-in pb-6">
      ...
      <section aria-label="Library">
        <div class="flex items-center justify-between mb-3">
          ...
          ${m.length>0?`<a href="#home/saved" onclick="navigate('#home/saved');return false" class="text-accent text-sm font-semibold hover:underline">View all</a>`:""}
        </div>
        ${v}
      </section>
    </div>`}function P(e){document.getElementById("modal-content").innerHTML=e,document.getElementById("modal-overlay").classList.remove("hidden")}function K(){document.getElementById("modal-overlay").classList.add("hidden")}window.openModal=P;window.closeModal=K;let re=null;function nt(){re&&(clearInterval(re),re=null)}async function zt(e){const t=window.location.hash||"#home",n=t==="#home"||t.startsWith("#home/saved");if(q().size===0||!n){nt();return}const a=await u("GET","/api/content",null,{limit:50});if(!a.ok)return;const o=a.data,s=Array.isArray(o)?o:(o==null?void 0:o.items)??[];let i=!1;s.forEach(r=>{q().has(r.id)&&r.ai_processed&&(I(r.id),i=!0)}),i&&n&&await Pe(e)}async function ot(e,t){(t==="saved"||t==="bookmarks")&&Ye(t),ue==="saved"?await Pe(e):await Ae(e)}function Nt(e){const t=(n,a)=>{const o=e===a;return`<button onclick="switchLibraryTab('${a}')" role="tab" aria-selected="${o}" class="flex-1 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 ${o?"bg-accent text-white shadow-sm":"text-muted hover:text-heading"}">${n}</button>`};return`<div class="flex bg-surface rounded-xl p-1 gap-1 mb-5 shadow-card" role="tablist" aria-label="Library view">
    ${t("Saved","saved")}
    ${t("Bookmarks","bookmarks")}
  </div>`}async function Pe(e){const t=await u("GET","/api/content",null,{limit:50});t.ok||F(t);const n=t.ok?t.data:null,a=Array.isArray(n)?n:(n==null?void 0:n.items)??[];a.forEach(o=>{o.ai_processed&&I(o.id)}),e.innerHTML=`
    <div class="fade-in">
    ...
    <div class="fade-in">
      ...
      ${i.length===0?`
        ...
        <div class="space-y-3" id="bookmarks-list">
          ${i.map(c=>Q(c,{showBookmark:!0,isBookmarked:!0,roundedMinimal:!0})).join("")}
        </div>`}
    </div>`}const ze={blue:"from-blue-500/20 to-blue-600/5 border-blue-500/20",green:"from-green-500/20 to-green-600/5 border-green-500/20",purple:"from-purple-500/20 to-purple-600/5 border-purple-500/20",amber:"from-amber-500/20 to-amber-600/5 border-amber-500/20",rose:"from-rose-500/20 to-rose-600/5 border-rose-500/20",indigo:"from-indigo-500/20 to-indigo-600/5 border-indigo-500/20"};function qt(e,t){return`
    ${t.length>0?`
      <div class="mb-5">
    ...
    ${e.length===0?`
      ...
      <div class="grid grid-cols-2 gap-3">
        ${e.map(n=>{const a=ze[n.theme]||ze.blue;return`
  ...
  `}async function Wt(e){const[t,n]=await Promise.all([u("GET","/api/collections"),u("GET","/api/collections/categories")]);t.ok||F(t),n.ok||F(n);const a=t.ok?Array.isArray(t.data)?t.data:[]:[],o=n.ok?Array.isArray(n.data)?n.data:[]:[];e.innerHTML=`
    <div class="fade-in">
      <h1 class="text-xl font-bold text-heading mb-4">Collections</h1>
      ${qt(a,o)}
    </div>`}async function Kt(){const e=document.getElementById("page");if(!e)return;const t=(window.location.hash||"").replace(/^#/,""),[n,a]=t.split("/"),o=document.getElementById("library-refresh-btn");if(o){o.disabled=!0;const s=o.querySelector(".material-icons-round");s&&s.classList.add("animate-spin")}if(n==="profile"&&a==="bookmarks"?await Ae(e,{standalone:!0,backHash:"#profile",backLabel:"Profile"}):await ot(e,ue),o){o.disabled=!1;const s=o.querySelector(".material-icons-round");s&&s.classList.remove("animate-spin")}}function Vt(e){Ye(e),E(e==="saved"?"#home":`#home/${e}`)}function we(e=""){return`
  ...
  `}function Jt(e=""){P(we(e))}async function Yt(e=null){const t=(window.location.hash||"").replace("#","");if(!((t==="home"||t==="home/saved")&&ue==="saved"))return;const a=await u("GET","/api/content",null,{limit:50});if(!a.ok)return;const o=a.data,s=Array.isArray(o)?o:(o==null?void 0:o.items)??[];s.forEach(r=>{r.ai_processed&&I(r.id)});const i=document.getElementById("content-list");if(i){const r=q();if(i.innerHTML=s.map(c=>{const m=e&&(c.id===e||(c.content_id||c.id)===e),g=Q(c,{showAiStatus:!0,processingIds:r,roundedMinimal:!0});return m?g.replace('<article class="','<article class="new-item-highlight '):g}).join(""),e){const c=i.querySelector(".new-item-highlight");c&&setTimeout(()=>c.classList.remove("new-item-highlight"),1500)}}else{const r=document.getElementById("page");r&&await Pe(r)}}async function Qt(){var a,o;const e=document.getElementById("m-url"),t=e?e.value.trim():"";if(!t){p("URL is required",!0);return}const n=document.getElementById("modal-content");n&&(n.innerHTML=Zt());try{const s=await u("POST","/api/content",{url:t});if(s.ok){const i=(a=s.data)==null?void 0:a.id;i&&(Qe(i),u("POST","/api/ai/process-content",{content_id:i}).catch(()=>{I(i),p("AI processing failed for this item",!0)})),K(),p("Link saved"),await Yt(i)}else n&&(n.innerHTML=we(t)),p(((o=s.data)==null?void 0:o.detail)||"Couldn't save link. Check the URL and try again.",!0)}catch{n&&(n.innerHTML=we(t)),p("Couldn't save link. Check the URL and try again.",!0)}}function Xt(){P(`
  ...
  `)}async function en(){var o;const e=document.getElementById("c-title").value.trim();if(!e){p("Title is required",!0);return}const t=document.getElementById("create-col-btn");t.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',t.disabled=!0;const n={title:e,description:document.getElementById("c-desc").value.trim()||null,icon:document.getElementById("c-icon").value.trim()||"folder",theme:document.getElementById("c-theme").value},a=await u("POST","/api/collections",n);a.ok?(K(),p("Collection created!"),E("#collection/"+a.data.id)):(p(((o=a.data)==null?void 0:o.detail)||"Failed to create",!0),t.textContent="Create Collection",t.disabled=!1)}window.refreshLibrary=Kt;window.switchLibraryTab=Vt;window.openSaveContentModal=Jt;window.doSaveContent=Qt;window.openCreateCollectionModal=Xt;window.doCreateCollection=en;function Ie(e,t,n="Confirm",a=!1){return new Promise(o=>{const s=document.getElementById("confirm-overlay");document.getElementById("confirm-content").innerHTML=`
    ...
    <div class="slide-in-right">
      ...
      <div class="mb-4">
        ...
        <a href="${d(o.url)}" target="_blank" rel="noopener" class="text-accent text-sm hover:underline break-all mt-1 inline-block">${d(Ee(o.url,60))}</a>
      </div>

      <!-- Badges -->
      <div class="flex items-center gap-2 flex-wrap mb-5">
        ${O(o.platform,"gray")}
        ${O(o.content_type,"purple")}
        ${O(o.ai_category,"emerald")}
    ...
    </div>`,i){window._contentDetailPoll&&clearInterval(window._contentDetailPoll);const c=o.id;window._contentDetailPoll=setInterval(async()=>{if((window.location.hash||"").indexOf("content-detail/"+c)===-1){window._contentDetailPoll&&clearInterval(window._contentDetailPoll),window._contentDetailPoll=null;return}const m=await u("GET",`/api/content/${c}`);m.ok&&m.data.ai_processed&&(window._contentDetailPoll&&clearInterval(window._contentDetailPoll),window._contentDetailPoll=null,I(c),Te("summary"),await j(e,c))},4e3)}else window._contentDetailPoll&&(clearInterval(window._contentDetailPoll),window._contentDetailPoll=null)}function tn(e,t){return ie==="summary"?e.ai_summary?`<div class="bg-card rounded-2xl p-5 shadow-sm border border-border">
    ...
    <div class="bg-card rounded-2xl p-5 shadow-sm border border-border space-y-3">
      ...
      <div class="grid grid-cols-2 gap-3">
        <div><label class="text-xs text-muted-foreground font-medium block mb-1">Platform</label><p class="text-body text-sm flex items-center gap-1"><span class="material-icons-round text-base">${ye(e.platform)}</span>${d(e.platform||"Unknown")}</p></div>
    ...
    </div>`}function nn(e,t){Te(e),j(document.getElementById("page"),t)}function on(e){P(`
  ...
  `)}async function an(e){var t;Qe(e),await j(document.getElementById("page"),e),typeof showProgress=="function"&&showProgress();try{const n=await u("POST","/api/ai/process-content",{content_id:e});n.ok?n.status===202?p("AI processing started — refresh the list in a moment"):(I(e),p("AI processing complete!"),Te("summary"),await j(document.getElementById("page"),e)):(I(e),p(((t=n.data)==null?void 0:t.detail)||"AI processing failed",!0),await j(document.getElementById("page"),e))}catch{I(e),p("AI processing failed",!0),await j(document.getElementById("page"),e)}finally{typeof hideProgress=="function"&&hideProgress()}}async function sn(e){const t=await u("GET","/api/collections"),n=t.ok?Array.isArray(t.data)?t.data:[]:[];P(`
  ...
  `)}async function rn(e,t){var a;const n=await u("POST",`/api/collections/${e}/items`,{content_id:t});n.ok?(K(),p("Added to collection!")):p(((a=n.data)==null?void 0:a.detail)||"Failed to add",!0)}async function ln(e){const t=await u("GET",`/api/content/${e}`);if(!t.ok)return;const n=t.data;P(`
  ...
  `)}async function dn(e){var o;const t=document.getElementById("edit-btn");t.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',t.disabled=!0;const n={title:document.getElementById("e-title").value.trim()||null,description:document.getElementById("e-desc").value.trim()||null,url:document.getElementById("e-url").value.trim()||null},a=await u("PATCH",`/api/content/${e}`,n);a.ok?(K(),p("Content updated!"),await j(document.getElementById("page"),e)):(p(((o=a.data)==null?void 0:o.detail)||"Failed to update",!0),t.textContent="Save Changes",t.disabled=!1)}async function cn(e){var a;if(!await Ie("Delete Content","This action cannot be undone. Are you sure?","Delete",!0))return;const n=await u("DELETE",`/api/content/${e}`);n.ok?(p("Deleted!"),E("#home")):p(((a=n.data)==null?void 0:a.detail)||"Failed to delete",!0)}window.switchContentTab=nn;window.openContentActions=on;window.processWithAI=an;window.openAddToCollectionModal=sn;window.addToCollection=rn;window.openEditContentModal=ln;window.doEditContent=dn;window.deleteContent=cn;async function Me(e,t){if(!t){E("#collections");return}const[n,a]=await Promise.all([u("GET",`/api/collections/${t}`),u("GET",`/api/collections/${t}/items`)]);if(!n.ok){e.innerHTML='<div class="text-center py-16 fade-in"><span class="material-icons-round text-5xl text-muted-foreground/60 mb-3">error</span><p class="text-muted-foreground">Collection not found</p></div>';return}const o=n.data,s=a.ok?Array.isArray(a.data)?a.data:[]:[];e.innerHTML=`
    <div class="slide-in-right">
      <!-- Header -->
    ...
    </div>`}async function un(e){const t=await u("GET","/api/content",null,{limit:50}),n=t.ok?Array.isArray(t.data)?t.data:[]:[];P(`
    <h2 class="text-lg font-bold text-heading mb-4">Add Content</h2>
  ...
  `)}async function mn(e,t){var a;const n=await u("DELETE",`/api/collections/${e}/items/${t}`);n.ok?(p("Removed from collection"),await Me(document.getElementById("page"),e)):p(((a=n.data)==null?void 0:a.detail)||"Failed to remove",!0)}async function pn(e){const t=await u("GET",`/api/collections/${e}`);if(!t.ok)return;const n=t.data;P(`
  ...
  `)}async function fn(e){var o;const t=document.getElementById("edit-col-btn");t.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',t.disabled=!0;const n={title:document.getElementById("ec-title").value.trim()||null,description:document.getElementById("ec-desc").value.trim()||null,is_shared:document.getElementById("ec-shared").checked},a=await u("PATCH",`/api/collections/${e}`,n);a.ok?(K(),p("Collection updated!"),await Me(document.getElementById("page"),e)):(p(((o=a.data)==null?void 0:o.detail)||"Failed to update",!0),t.textContent="Save Changes",t.disabled=!1)}async function gn(e){var a;if(!await Ie("Delete Collection","This will remove the collection but not its content. Continue?","Delete",!0))return;const n=await u("DELETE",`/api/collections/${e}`);n.ok?(p("Deleted!"),E("#collections")):p(((a=n.data)==null?void 0:a.detail)||"Failed to delete",!0)}window.openAddContentToCollectionModal=un;window.removeFromCollection=mn;window.openEditCollectionModal=pn;window.doEditCollection=fn;window.deleteCollection=gn;async function X(e){const[t,n]=await Promise.all([u("GET","/api/goals",null,{status:R}),R==="active"?u("GET","/api/goals/suggestions",null,{status:"pending"}):Promise.resolve({ok:!0,data:[]})]),a=t.ok?Array.isArray(t.data)?t.data:[]:[],o=n.ok?Array.isArray(n.data)?n.data:[]:[],s=a.filter(l=>!l.parent_goal_id),i={};a.filter(l=>l.parent_goal_id).forEach(l=>{i[l.parent_goal_id]||(i[l.parent_goal_id]=[]),i[l.parent_goal_id].push(l)});const r=a.flatMap(l=>l.steps||[]),c=r.length,m=r.filter(l=>l.is_completed).length,g=c>0?Math.round(m/c*100):0;e.innerHTML=`
    <div class="fade-in">
      ...
      <div class="flex items-center justify-between mb-5">
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="text-muted-foreground text-xs">${a.length} goal${a.length!==1?"s":""} &middot; ${m}/${c} steps</p>
          </div>
        </div>
      ...
      ${o.length>0?`
        <button onclick="toggleSuggestions()" class="w-full bg-purple-500/10 border border-purple-500/20 rounded-md p-4 mb-4 flex items-center gap-3 transition-all active:scale-[0.98]" aria-expanded="${D}">
          ...
          <div class="flex-1 text-left">
            ...
            <p class="text-muted-foreground text-xs">Tap to ${D?"hide":"review"}</p>
          </div>
          <span class="material-icons-round text-muted-foreground transition-transform ${D?"rotate-180":""}">${D?"expand_less":"expand_more"}</span>
        </button>
        ${D?`<div class="space-y-3 mb-4">${o.map(xn).join("")}</div>`:""}
      `:""}
      ...
      ${s.length===0&&o.length===0?`
        ...
        <div class="space-y-3">
          ${s.map(l=>bn(l,i[l.id]||[])).join("")}
        </div>`}
    </div>`}function bn(e,t=[]){const n=Math.round((e.confidence||0)*100),a=(e.evidence_content_ids||[]).length,o=t.length>0,s=e.steps||[],i=s.filter(l=>l.is_completed).length,r=s.length,c=r>0?Math.round(i/r*100):0,g={active:"border-l-accent",completed:"border-l-success",dismissed:"border-l-muted"}[e.status]||"border-l-accent";return`
    ...
    </article>`}function xn(e){const t=(e.child_goal_ids||[]).length;return`
    ...
    </div>`}function hn(){Tt(!D),X(document.getElementById("page"))}function vn(){P(`
  ...
  `)}async function yn(e){var a,o;const t=document.getElementById("accept-"+e);t&&(t.innerHTML='<div class="spinner" style="width:14px;height:14px;border-width:2px;"></div>',t.disabled=!0);const n=await u("POST",`/api/goals/suggestions/${e}/accept`);n.ok?(p(((a=n.data)==null?void 0:a.message)||"Goals merged!"),X(document.getElementById("page"))):(p(((o=n.data)==null?void 0:o.detail)||"Failed to merge",!0),t&&(t.textContent="Accept",t.disabled=!1))}async function wn(e){var a;const t=document.getElementById("dismiss-"+e);t&&(t.innerHTML='<div class="spinner" style="width:14px;height:14px;border-width:2px;"></div>',t.disabled=!0);const n=await u("POST",`/api/goals/suggestions/${e}/dismiss`);n.ok?(p("Suggestion dismissed"),X(document.getElementById("page"))):(p(((a=n.data)==null?void 0:a.detail)||"Failed to dismiss",!0),t&&(t.textContent="Dismiss",t.disabled=!1))}async function kn(){var t,n;p("Starting consolidation...");const e=await u("POST","/api/goals/consolidate");e.ok?p(((t=e.data)==null?void 0:t.message)||"Finding similar goals…"):p(((n=e.data)==null?void 0:n.detail)||"Couldn't find goals to combine",!0)}async function $n(){var t,n;p("Refreshing goals…");const e=await u("POST","/api/goals/reanalyze");e.ok?p(((t=e.data)==null?void 0:t.message)||"Goals refreshed!"):p(((n=e.data)==null?void 0:n.detail)||"Refresh failed",!0)}function _n(e){Ct(e),X(document.getElementById("page"))}window.setGoalsFilterAndRender=_n;window.toggleSuggestions=hn;window.openGoalsMenu=vn;window.acceptSuggestion=yn;window.dismissSuggestion=wn;window.triggerConsolidate=kn;window.reanalyzeGoals=$n;async function pe(e,t){if(!t){E("#goals");return}const n=await u("GET",`/api/goals/${t}`);if(!n.ok){e.innerHTML='<div class="text-center py-16 fade-in"><span class="material-icons-round text-5xl text-muted-foreground/60 mb-3">error</span><p class="text-muted-foreground">Goal not found</p></div>';return}const a=n.data,o=a.steps||[],s=o.filter(y=>y.is_completed),i=o.filter(y=>!y.is_completed),r=s.length,c=o.length,m=c>0?Math.round(r/c*100):0,g=Math.round((a.confidence||0)*100),l=(a.evidence_content_ids||[]).length,f=a.children||[],v=f.length>0,b=!!a.parent_goal_id,h=`hsl(${getComputedStyle(document.documentElement).getPropertyValue("--primary").trim()})`;e.innerHTML=`
    <div class="slide-in-right">
      <!-- Header -->
      <div class="flex items-center gap-3 mb-4">
        ...
        <div class="flex items-center gap-4 mb-4">
          ...
          <div class="flex-1 min-w-0">
            ...
            <div class="flex items-center gap-2 mt-1 flex-wrap">
              ${O(a.category,"emerald")}
              ${O(a.status,a.status==="active"?"indigo":a.status==="completed"?"green":"gray")}
              ${v?'<span class="inline-block px-2 py-0.5 rounded-full text-[11px] font-semibold bg-purple-500/15 text-purple-500">Parent</span>':""}
      ...
      <section class="mb-4" aria-label="Sub-goals">
        ...
        <div class="flex gap-3 overflow-x-auto no-scrollbar pb-1">
          ${f.map(y=>{const ge=Math.round((y.confidence||0)*100),M=y.status||"active",ee=M==="completed"?"check_circle":M==="dismissed"?"do_not_disturb_on":"flag",te=M==="completed"?"text-success":M==="dismissed"?"text-muted-foreground":"text-accent";return`
            <article onclick="navigate('#goal-detail/${y.id}')" class="flex-shrink-0 w-44 bg-card rounded-xl p-3.5 shadow-sm border border-border hover:shadow-elevated transition-all cursor-pointer active:scale-[0.97]">
              <div class="flex items-center gap-2 mb-2">
                <span class="material-icons-round text-lg ${te}">${ee}</span>
                <span class="text-[10px] text-muted-foreground">${ge}%</span>
              </div>
          ...
          <div class="space-y-2" id="goal-steps-list">
            ...
            ${r>0?`
              <button onclick="toggleCompletedSteps('${t}')" class="w-full flex items-center justify-center gap-1.5 py-2.5 text-xs text-muted-foreground font-medium hover:text-heading transition-colors">
                <span class="material-icons-round text-sm">${le?"expand_less":"expand_more"}</span>
                ${r} completed step${r!==1?"s":""}
              </button>
              ${le?s.map(y=>Ne(y,t)).join(""):""}
            `:""}
          </div>`}
      </section>
    ...
    </div>`}function Ne(e,t){const n=(e.source_content_ids||[]).length;return`
    ...
    </div>`}function Sn(e){Et(!le),pe(document.getElementById("page"),e)}async function Cn(e,t,n){var o;const a=await u("PATCH",`/api/goals/${e}/steps/${t}`,{is_completed:n});a.ok?await pe(document.getElementById("page"),e):p(((o=a.data)==null?void 0:o.detail)||"Failed to update step",!0)}async function Tn(e,t){var a;const n=await u("PATCH",`/api/goals/${e}`,{status:t});n.ok?(p(`Goal ${t==="completed"?"completed":t==="dismissed"?"dismissed":"reactivated"}!`),await pe(document.getElementById("page"),e)):p(((a=n.data)==null?void 0:a.detail)||"Failed to update goal",!0)}async function En(e){var a;if(!await Ie("Delete Goal","This will delete the goal and all its steps. Continue?","Delete",!0))return;const n=await u("DELETE",`/api/goals/${e}`);n.ok?(p("Goal deleted"),E("#goals")):p(((a=n.data)==null?void 0:a.detail)||"Failed to delete",!0)}window.toggleCompletedSteps=Sn;window.toggleGoalStep=Cn;window.updateGoalStatus=Tn;window.deleteGoal=En;function at(){try{return JSON.parse(localStorage.getItem("zuno_searches")||"[]")}catch{return[]}}function Ln(e){const t=at().filter(n=>n!==e);t.unshift(e),localStorage.setItem("zuno_searches",JSON.stringify(t.slice(0,5)))}async function Pn(e){const t=await u("GET","/api/tags/popular"),n=t.ok?Array.isArray(t.data)?t.data:[]:[],a=at();e.innerHTML=`
    <div class="fade-in">
      <!-- Search Input -->
    ...
    </div>`;const a=document.getElementById("knowledge-chat");a.scrollTop=a.scrollHeight}function ke(e){return e.role==="user"?`<div class="flex justify-end"><div class="bg-accent/20 text-heading rounded-md px-4 py-3 max-w-[80%] text-sm">${d(e.text)}</div></div>`:`
            ...
            <div class="space-y-1.5">
              ${e.sources.map(t=>`
                <div class="bg-bg rounded-md px-3 py-2.5 cursor-pointer hover:bg-card-hover transition-colors" onclick="navigate('#content-detail/${t.content_id}')">
                  ...
                  ${t.chunk_text?`<p class="text-muted-foreground text-[11px] line-clamp-2 mt-0.5">${d(Ee(t.chunk_text,100))}</p>`:""}
                </div>`).join("")}
            </div>
          </div>`:""}
      </div>
    </div>`}function In(e){document.getElementById("knowledge-input").value=e,lt()}async function lt(){var s,i;const e=document.getElementById("knowledge-input"),t=e.value.trim();if(!t)return;e.value="",De({role:"user",text:t});const n=document.getElementById("knowledge-chat");Y.length===1&&(n.innerHTML=""),n.innerHTML+=ke({role:"user",text:t}),n.innerHTML+='<div id="typing" class="flex justify-start"><div class="bg-card border border-border rounded-md px-5 py-4 shadow-sm"><div class="flex gap-1.5"><span class="typing-dot"></span><span class="typing-dot"></span><span class="typing-dot"></span></div></div></div>',n.scrollTop=n.scrollHeight;const a=await u("POST","/api/knowledge/ask",{query:t,include_sources:!0});(s=document.getElementById("typing"))==null||s.remove();const o=a.ok?{role:"assistant",text:a.data.answer,sources:a.data.sources||[]}:{role:"assistant",text:`Error: ${((i=a.data)==null?void 0:i.detail)||"Failed to get answer"}`,sources:[]};De(o),n.innerHTML+=ke(o),n.scrollTop=n.scrollHeight}function Mn(){P(`
  ...
  `)}async function Bn(){var t;p("Updating knowledge base...");const e=await u("POST","/api/knowledge/reindex",{});e.ok?p(`Updated: ${e.data.content_processed} items in your knowledge base`):p(((t=e.data)==null?void 0:t.detail)||"Update failed",!0)}function Hn(){Pt(),it(document.getElementById("page"))}window.askSuggested=In;window.doAsk=lt;window.openKnowledgeSettings=Mn;window.doReindex=Bn;window.clearKnowledgeAndRender=Hn;async function Be(e){var c;const[t,n,a]=await Promise.all([u("GET","/api/profile"),u("GET","/api/user-preferences"),u("GET","/api/admin/me")]),o=t.ok?t.data:{},s=n.ok?n.data:{},i=pt(),r=a.ok&&((c=a.data)==null?void 0:c.admin)===!0;e.innerHTML=`
    <div class="fade-in">
      <!-- Avatar Hero -->
        ...
        <div>
          ...
          <div class="flex gap-2">
            ${["light","dark","system"].map(m=>`
              <button onclick="applyTheme('${m}');renderProfile(document.getElementById('page'))" class="flex-1 py-2.5 rounded-md text-sm font-medium transition-all duration-200 flex items-center justify-center gap-1.5 ${i===m?"bg-primary text-primary-foreground border-primary/30":"bg-card border border-border text-foreground"} active:scale-[0.97]">
    ...
    </div>`}async function jn(){var a;const e=document.getElementById("profile-btn");e.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',e.disabled=!0;const t={display_name:document.getElementById("p-name").value.trim()||null,avatar_url:document.getElementById("p-avatar").value.trim()||null},n=await u("PATCH","/api/profile",t);n.ok?(Ce(null),p("Profile updated!")):p(((a=n.data)==null?void 0:a.detail)||"Failed to update",!0),e.textContent="Update Profile",e.disabled=!1}async function Gn(e){await u("PATCH","/api/user-preferences",{feed_type:e}),p("Feed preference updated!"),await Be(document.getElementById("page"))}window.renderProfile=Be;window.doUpdateProfile=jn;window.updateFeedPref=Gn;async function dt(e){var n;const t=await u("GET","/api/admin/me");if(!t.ok||!((n=t.data)!=null&&n.admin)){E("#profile");return}e.innerHTML=`
    <div class="fade-in">
      <div class="flex items-center gap-3 mb-5">
    ...
    </div>`}async function Rn(){var n;const e=await u("GET","/api/admin/cache/stats"),t=document.getElementById("admin-cache-stats-result");e.ok?t.innerHTML=`<pre class="text-xs text-muted-foreground bg-bg rounded-xl p-3 overflow-x-auto max-h-32">${d(JSON.stringify(e.data,null,2))}</pre>`:t.innerHTML=`<p class="text-danger text-xs">${d(((n=e.data)==null?void 0:n.detail)||"Failed to load stats")}</p>`}async function Dn(){var a;const e=document.getElementById("admin-bust-btn");e.innerHTML='<div class="spinner" style="width:14px;height:14px;border-width:2px;"></div>',e.disabled=!0;const t=document.getElementById("admin-cache-pattern").value.trim(),n=await u("POST","/api/admin/cache/bust",null,t?{pattern:t}:null);n.ok?p("Cache busted!"):p(((a=n.data)==null?void 0:a.detail)||"Failed",!0),e.textContent="Bust",e.disabled=!1}async function On(){var n;const e=document.getElementById("admin-prompts-btn");e.innerHTML='<div class="spinner" style="width:16px;height:16px;border-width:2px;"></div>',e.disabled=!0;const t=await u("POST","/api/admin/prompts/reload");t.ok?p("Prompts reloaded!"):p(((n=t.data)==null?void 0:n.detail)||"Failed",!0),e.innerHTML='<span class="material-icons-round text-base">refresh</span> Reload Prompts',e.disabled=!1}async function Fn(){var o,s,i;const e=document.getElementById("admin-embed-text").value.trim();if(!e){p("Enter text",!0);return}const t=document.getElementById("admin-embed-btn");t.innerHTML='<div class="spinner" style="width:14px;height:14px;border-width:2px;"></div>',t.disabled=!0;const n=await u("POST","/api/ai/generate-embedding",{text:e}),a=document.getElementById("admin-embed-result");if(n.ok){const r=((o=n.data.embedding)==null?void 0:o.length)||0;a.innerHTML=`<p class="text-success text-xs">Embedding generated (${r} dimensions)</p><pre class="text-xs text-muted-foreground bg-bg rounded-lg p-2 mt-1 max-h-24 overflow-y-auto">[${(s=n.data.embedding)==null?void 0:s.slice(0,5).map(c=>c.toFixed(6)).join(", ")}... ]</pre>`}else a.innerHTML=`<p class="text-danger text-xs">${d(((i=n.data)==null?void 0:i.detail)||"Failed")}</p>`;t.textContent="Go",t.disabled=!1}async function Un(){var a,o;const e=document.getElementById("admin-gen-feed-btn");e.innerHTML='<div class="spinner" style="width:16px;height:16px;border-width:2px;"></div> Generating...',e.disabled=!0;const t=await u("POST","/api/ai/generate-feed"),n=document.getElementById("admin-gen-feed-result");if(t.ok){const s=((a=t.data.items)==null?void 0:a.length)||0;n.innerHTML=`<p class="text-success text-xs">${s} feed items generated</p>`,t.data.message&&(n.innerHTML+=`<p class="text-muted-foreground text-xs mt-1">${d(t.data.message)}</p>`)}else n.innerHTML=`<p class="text-danger text-xs">${d(((o=t.data)==null?void 0:o.detail)||"Failed")}</p>`;e.innerHTML='<span class="material-icons-round text-base">auto_awesome</span> Generate Feed',e.disabled=!1}async function zn(){const e=document.getElementById("admin-health-btn");e.innerHTML='<div class="spinner" style="width:16px;height:16px;border-width:2px;"></div>',e.disabled=!0;const t=await u("GET","/health");document.getElementById("admin-health-result").innerHTML=`<pre class="text-xs ${t.ok?"text-success":"text-danger"} bg-bg rounded-lg p-2 mt-1">${d(JSON.stringify(t.data,null,2))}</pre>`,e.innerHTML='<span class="material-icons-round text-base">monitor_heart</span> Check Health',e.disabled=!1}let $e=[];async function Nn(){var i,r,c;const e=document.getElementById("admin-waitlist-btn"),t=document.getElementById("admin-waitlist-result");e.innerHTML='<div class="spinner" style="width:16px;height:16px;border-width:2px;"></div> Loading...',e.disabled=!0;const n=await u("GET","/api/admin/waitlist");if(!n.ok){t.innerHTML=`<p class="text-danger text-xs">${d(((i=n.data)==null?void 0:i.detail)||"Failed to load waitlist")}</p>`,e.innerHTML='<span class="material-icons-round text-base">list</span> Load waitlist',e.disabled=!1;return}const a=((r=n.data)==null?void 0:r.items)||[];$e=a;const o=((c=n.data)==null?void 0:c.total)??a.length,s=a.map(m=>`<tr class="border-b border-border"><td class="py-2 pr-3 text-sm text-heading">${d(m.email)}</td><td class="py-2 pr-3 text-xs text-muted-foreground">${d(m.tier)}</td><td class="py-2 pr-3 text-xs text-muted-foreground">${d(m.discount_code||"—")}</td><td class="py-2 text-xs text-muted-foreground">${m.created_at?new Date(m.created_at).toLocaleDateString():"—"}</td></tr>`).join("");t.innerHTML=`
  ...
  `,e.innerHTML='<span class="material-icons-round text-base">list</span> Load waitlist',e.disabled=!1}function qn(){if($e.length===0)return;const e=["email","tier","discount_code","created_at"],t=[e.join(",")].concat($e.map(o=>e.map(s=>`"${String(o[s]||"").replace(/"/g,'""')}"`).join(","))).join(`
`),n=new Blob([t],{type:"text/csv;charset=utf-8"}),a=document.createElement("a");a.href=URL.createObjectURL(n),a.download=`zuno-waitlist-${new Date().toISOString().slice(0,10)}.csv`,a.click(),URL.revokeObjectURL(a.href)}window.renderAdmin=dt;window.adminLoadCacheStats=Rn;window.adminDoBustCache=Dn;window.adminDoReloadPrompts=On;window.adminDoGenerateEmbedding=Fn;window.adminDoGenerateFeed=Un;window.adminDoHealthCheck=zn;window.adminLoadWaitlist=Nn;window.adminExportWaitlistCsv=qn;const ae=["content-detail","collection","goal-detail"];let S=0;function Wn(e){return se?ae.includes(e)&&!ae.includes(se)?"slide-in-right":ae.includes(se)&&!ae.includes(e)?"slide-in-left":"fade-in":"fade-in"}function Kn(e){if(typeof document.startViewTransition=="function")return document.startViewTransition(e);const t=e();return t&&typeof t.then=="function"?t.then(()=>{}):Promise.resolve()}async function k(){var g;const e=++S,t=localStorage.getItem("zuno_token");let{page:n,id:a}=yt();if(!n){C(t?"#home":"#auth"),queueMicrotask(()=>k());return}if(n==="collection"&&!a){C("#collections"),queueMicrotask(()=>k());return}if(!t&&n!=="auth"&&n!=="connect-extension"){C("#auth"),queueMicrotask(()=>k());return}if(t&&n==="auth"){C("#home"),queueMicrotask(()=>k());return}const o=document.getElementById("page");if(!o)return;if(n==="connect-extension"){try{window.ZUNO_API_BASE=Se()}catch{window.ZUNO_API_BASE=((g=window.location)==null?void 0:g.origin)||""}o.innerHTML=`<div class="flex flex-col items-center justify-center py-16 text-center fade-in">
      ...
      <p class="text-muted-foreground text-sm">Make sure you're logged in. If nothing happens, ensure the Share to Zuno extension is installed.</p>
    </div>`,document.getElementById("topnav").classList.add("hidden"),document.getElementById("bottomnav").classList.add("hidden");return}if(n==="feed"){C("#home"),queueMicrotask(()=>k());return}if(n==="library"){const l=a==="collections"?"collections":a==="bookmarks"?"bookmarks":"saved";C(l==="collections"?"#collections":l==="bookmarks"?"#profile/bookmarks":"#home"),queueMicrotask(()=>k());return}if(n==="content"){C("#home"),queueMicrotask(()=>k());return}if(n==="home"&&a==="collections"){C("#collections"),queueMicrotask(()=>k());return}if(n==="home"&&a==="bookmarks"){C("#profile/bookmarks"),queueMicrotask(()=>k());return}const s=n==="auth";document.getElementById("topnav").classList.toggle("hidden",s),document.getElementById("topnav").classList.toggle("flex",!s),document.getElementById("bottomnav").classList.toggle("hidden",s);const i=document.getElementById("nav-feed");i&&i.classList.toggle("hidden",!0);const r={home:"home",feed:"feed",collections:"home","content-detail":"home",collection:"home",goals:"goals","goal-detail":"goals",knowledge:"knowledge",profile:"profile",admin:"profile"};document.querySelectorAll(".nav-btn").forEach(l=>{const f=l.dataset.tab===r[n];l.setAttribute("aria-current",f?"page":"false")});const c=Wn(n);It(n),typeof window.showProgress=="function"&&window.showProgress();const m={home:Z(3),feed:Z(3),collections:Z(3),goals:Z(3),"content-detail":xe(),"goal-detail":xe(),collection:xe(),admin:Oe()};try{await Kn(async()=>{if(e===S){o.innerHTML=`<div class="${c}">${m[n]||Oe()}</div>`;try{switch(n){case"auth":Xe(o);break;case"home":if(a==="saved"?await ot(o,"saved"):await Ut(o),e!==S)return;try{const l=sessionStorage.getItem("zuno_pending_share");l&&(sessionStorage.removeItem("zuno_pending_share"),typeof openSaveContentModal=="function"&&openSaveContentModal(l))}catch{}break;case"feed":xt();break;case"collections":if(await Wt(o),e!==S)return;try{const l=sessionStorage.getItem("zuno_pending_share");l&&(sessionStorage.removeItem("zuno_pending_share"),typeof openSaveContentModal=="function"&&openSaveContentModal(l))}catch{}break;case"content-detail":if(await j(o,a),e!==S)return;break;case"collection":if(await Me(o,a),e!==S)return;break;case"goals":if(await X(o),e!==S)return;break;case"goal-detail":if(await pe(o,a),e!==S)return;break;case"search":if(await Pn(o),e!==S)return;break;case"knowledge":if(await it(o),e!==S)return;break;case"profile":if(a==="bookmarks"?await Ae(o,{standalone:!0,backHash:"#profile",backLabel:"Profile"}):await Be(o),e!==S)return;break;case"admin":if(await dt(o),e!==S)return;break;default:C("#home"),queueMicrotask(()=>k());return}}catch(l){if(e!==S)return;const f=typeof(l==null?void 0:l.message)=="string"?l.message:"Something went wrong";o.innerHTML=`<div class="flex flex-col items-center justify-center py-16 text-center fade-in" role="alert" aria-live="assertive">
        ...
        </div>`}}})}finally{typeof window.hideProgress=="function"&&window.hideProgress()}}window.router=k;/*! Capacitor: https://capacitorjs.com/ - MIT License */var W;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(W||(W={}));class he extends Error{constructor(t,n,a){super(t),this.message=t,this.code=n,this.data=a}}const Vn=e=>{var t,n;return e!=null&&e.androidBridge?"android":!((n=(t=e==null?void 0:e.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||n===void 0)&&n.bridge?"ios":"web"},Zn=e=>{const t=e.CapacitorCustomPlatform||null,n=e.Capacitor||{},a=n.Plugins=n.Plugins||{},o=()=>t!==null?t.name:Vn(e),s=()=>o()!=="web",i=l=>{const f=m.get(l);return!!(f!=null&&f.platforms.has(o())||r(l))},r=l=>{var f;return(f=n.PluginHeaders)===null||f===void 0?void 0:f.find(v=>v.name===l)},c=l=>e.console.error(l),m=new Map,g=(l,f={})=>{const v=m.get(l);if(v)return console.warn(`Capacitor plugin "${l}" already registered. Cannot register plugins twice.`),v.proxy;const b=o(),_=r(l);let h;const y=async()=>(!h&&b in f?h=typeof f[b]=="function"?h=await f[b]():h=f[b]:t!==null&&!h&&"web"in f&&(h=typeof f.web=="function"?h=await f.web():h=f.web),h),ge=(w,$)=>{var L,B;if(_){const H=_==null?void 0:_.methods.find(T=>$===T.name);if(H)return H.rtype==="promise"?T=>n.nativePromise(l,$.toString(),T):(T,ne)=>n.nativeCallback(l,$.toString(),T,ne);if(w)return(L=w[$])===null||L===void 0?void 0:L.bind(w)}else{if(w)return(B=w[$])===null||B===void 0?void 0:B.bind(w);throw new he(`"${l}" plugin is not implemented on ${b}`,W.Unimplemented)}},M=w=>{let $;const L=(...B)=>{const H=y().then(T=>{const ne=ge(T,w);if(ne){const oe=ne(...B);return $=oe==null?void 0:oe.remove,oe}else throw new he(`"${l}.${w}()" is not implemented on ${b}`,W.Unimplemented)});return w==="addListener"&&(H.remove=async()=>$()),H};return L.toString=()=>`${w.toString()}() { [capacitor code] }`,Object.defineProperty(L,"name",{value:w,writable:!1,configurable:!1}),L},ee=M("addListener"),te=M("removeListener"),ut=(w,$)=>{const L=ee({eventName:w},$),B=async()=>{const T=await L;te({eventName:w,callbackId:T},$)},H=new Promise(T=>L.then(()=>T({remove:B})));return H.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await B()},H},be=new Proxy({},{get(w,$){switch($){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return _?ut:ee;case"removeListener":return te;default:return M($)}}});return a[l]=be,m.set(l,{name:l,proxy:be,platforms:new Set([...Object.keys(f),..._?[b]:[]])}),be};return n.convertFileSrc||(n.convertFileSrc=l=>l),n.getPlatform=o,n.handleError=c,n.isNativePlatform=s,n.isPluginAvailable=i,n.registerPlugin=g,n.Exception=he,n.DEBUG=!!n.DEBUG,n.isLoggingEnabled=!!n.isLoggingEnabled,n},Jn=e=>e.Capacitor=Zn(e),_e=Jn(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),fe=_e.registerPlugin;class He{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,n){let a=!1;this.listeners[t]||(this.listeners[t]=[],a=!0),this.listeners[t].push(n);const s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),a&&this.sendRetainedArgumentsForEvent(t);const i=async()=>this.removeListener(t,n);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,n,a){const o=this.listeners[t];if(!o){if(a){let s=this.retainedEventArguments[t];s||(s=[]),s.push(n),this.retainedEventArguments[t]=s}return}o.forEach(s=>s(n))}hasListeners(t){var n;return!!(!((n=this.listeners[t])===null||n===void 0)&&n.length)}registerWindowListener(t,n){this.windowListeners[n]={registered:!1,windowEventName:t,pluginEventName:n,handler:a=>{this.notifyListeners(n,a)}}}unimplemented(t="not implemented"){return new _e.Exception(t,W.Unimplemented)}unavailable(t="not available"){return new _e.Exception(t,W.Unavailable)}async removeListener(t,n){const a=this.listeners[t];if(!a)return;const o=a.indexOf(n);this.listeners[t].splice(o,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const n=this.retainedEventArguments[t];n&&(delete this.retainedEventArguments[t],n.forEach(a=>{this.notifyListeners(t,a)}))}}const qe=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),We=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Yn extends He{async getCookies(){const t=document.cookie,n={};return t.split(";").forEach(a=>{if(a.length<=0)return;let[o,s]=a.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");o=We(o).trim(),s=We(s).trim(),n[o]=s}),n}async setCookie(t){try{const n=qe(t.key),a=qe(t.value),o=`; expires=${(t.expires||"").replace("expires=","")}`,s=(t.path||"/").replace("path=",""),i=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${n}=${a||""}${o}; path=${s}; ${i};`}catch(n){return Promise.reject(n)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(n){return Promise.reject(n)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const n of t)document.cookie=n.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}fe("CapacitorCookies",{web:()=>new Yn});const Qn=async e=>new Promise((t,n)=>{const a=new FileReader;a.onload=()=>{const o=a.result;t(o.indexOf(",")>=0?o.split(",")[1]:o)},a.onerror=o=>n(o),a.readAsDataURL(e)}),Xn=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(o=>o.toLocaleLowerCase()).reduce((o,s,i)=>(o[s]=e[t[i]],o),{})},eo=(e,t=!0)=>e?Object.entries(e).reduce((a,o)=>{const[s,i]=o;let r,c;return Array.isArray(i)?(c="",i.forEach(m=>{r=t?encodeURIComponent(m):m,c+=`${s}=${r}&`}),c.slice(0,-1)):(r=t?encodeURIComponent(i):i,c=`${s}=${r}`),`${a}&${c}`},"").substr(1):null,to=(e,t={})=>{const n=Object.assign({method:e.method||"GET",headers:e.headers},t),o=Xn(e.headers)["content-type"]||"";if(typeof e.data=="string")n.body=e.data;else if(o.includes("application/x-www-form-urlencoded")){const s=new URLSearchParams;for(const[i,r]of Object.entries(e.data||{}))s.set(i,r);n.body=s.toString()}else if(o.includes("multipart/form-data")||e.data instanceof FormData){const s=new FormData;if(e.data instanceof FormData)e.data.forEach((r,c)=>{s.append(c,r)});else for(const r of Object.keys(e.data))s.append(r,e.data[r]);n.body=s;const i=new Headers(n.headers);i.delete("content-type"),n.headers=i}else(o.includes("application/json")||typeof e.data=="object")&&(n.body=JSON.stringify(e.data));return n};class no extends He{async request(t){const n=to(t,t.webFetchExtra),a=eo(t.params,t.shouldEncodeUrlParams),o=a?`${t.url}?${a}`:t.url,s=await fetch(o,n),i=s.headers.get("content-type")||"";let{responseType:r="text"}=s.ok?t:{};i.includes("application/json")&&(r="json");let c,m;switch(r){case"arraybuffer":case"blob":m=await s.blob(),c=await Qn(m);break;case"json":c=await s.json();break;case"document":case"text":default:c=await s.text()}const g={};return s.headers.forEach((l,f)=>{g[f]=l}),{data:c,headers:g,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}fe("CapacitorHttp",{web:()=>new no});var Ke;(function(e){e.Dark="DARK",e.Light="LIGHT",e.Default="DEFAULT"})(Ke||(Ke={}));var Ve;(function(e){e.StatusBar="StatusBar",e.NavigationBar="NavigationBar"})(Ve||(Ve={}));class oo extends He{async setStyle(){this.unavailable("not available for web")}async setAnimation(){this.unavailable("not available for web")}async show(){this.unavailable("not available for web")}async hide(){this.unavailable("not available for web")}}fe("SystemBars",{web:()=>new oo});const ao=fe("App",{web:()=>ce(()=>import("./web-D34400JA.js"),[]).then(e=>new e.AppWeb)}),so=80,ro=200;let x=null,z=!1,N=0,J=null,G=null,ct=0;function io(){return x||(x=document.createElement("div"),x.id="global-loading-bar",x.setAttribute("role","progressbar"),x.setAttribute("aria-label","Loading"),x.setAttribute("aria-hidden","true"),x.className="global-loading-bar hidden",x.innerHTML='<div class="global-loading-bar-inner"></div>',document.body.appendChild(x),x)}function lo(){!x||z||(G&&(clearTimeout(G),G=null),x.classList.remove("hidden"),x.setAttribute("aria-hidden","false"),z=!0,ct=Date.now())}function co(){if(!x)return;const e=Date.now()-ct,t=Math.max(0,ro-e);t>0&&z?G=setTimeout(()=>{G=null,x.classList.add("hidden"),x.setAttribute("aria-hidden","true"),z=!1},t):(x.classList.add("hidden"),x.setAttribute("aria-hidden","true"),z=!1)}function uo(){N++,io(),N===1&&(G&&(clearTimeout(G),G=null),J=setTimeout(()=>{J=null,N>0&&lo()},so))}function mo(){N>0&&N--,N===0&&(J&&(clearTimeout(J),J=null),z&&co())}window.showProgress=uo;window.hideProgress=mo;function po(){const e=document.createElement("header");e.id="topnav",e.setAttribute("role","banner"),e.className="hidden sticky top-0 z-30 bg-transparent px-5 py-3 flex items-center justify-between safe-top mt-4";const t=typeof import.meta<"u"&&"/app/"||"/app/";return e.innerHTML=`
  ...
  `,e}function fo(e){const t=document.getElementById("app-header-root");if(!t)return null;const n=po();return t.appendChild(n),n}function go(){const e=document.createElement("nav");return e.id="bottomnav",e.setAttribute("role","navigation"),e.setAttribute("aria-label","Main navigation"),e.className="hidden fixed bottom-0 left-0 right-0 border-t border-border px-6 py-4 z-30 safe-bottom",e.innerHTML=`
  ...
  `,e}function bo(e){const t=document.getElementById("bottom-nav-root");if(!t)return null;const n=go();return t.appendChild(n),n}const xo=/https?:\/\/[^\s)<>]+/i;async function ho(e){if(!e||!e.content)return;if(!localStorage.getItem("zuno_token")){p("Please log in to save shared content",!0);return}try{typeof showProgress=="function"&&showProgress();try{e.type==="text"?await vo(e.content):e.type==="image"&&await yo(e.content,e.mimeType||"image/jpeg")}finally{typeof hideProgress=="function"&&hideProgress()}}catch(n){console.error("[ShareHandler]",n),p("Failed to save shared content",!0),typeof hideProgress=="function"&&hideProgress()}}async function vo(e){var n,a;const t=e.match(xo);if(t){const o=t[0],s=await u("POST","/api/content",{url:o});s.ok?(p("Saved to Zuno!"),u("POST","/api/ai/process-content",{content_id:s.data.id})):p(((n=s.data)==null?void 0:n.detail)||"Failed to save link",!0)}else{const o=e.length>80?e.slice(0,77)+"...":e,s=await u("POST","/api/content/text",{title:o,source_text:e});s.ok?p("Note saved to Zuno!"):p(((a=s.data)==null?void 0:a.detail)||"Failed to save note",!0)}}async function yo(e,t){const n=atob(e),a=new Uint8Array(n.length);for(let f=0;f<n.length;f++)a[f]=n.charCodeAt(f);const o=new Blob([a],{type:t}),s=t.split("/")[1]||"jpg",i=`shared_${Date.now()}.${s}`,r=new FormData;r.append("file",o,i);const c=window.ZUNO_API_BASE||(window.location.hostname==="localhost"&&!window.location.port?"http://10.0.2.2:8000":window.location.origin),m=localStorage.getItem("zuno_token"),g=await fetch(`${c}/api/v1/content/upload`,{method:"POST",headers:m?{Authorization:`Bearer ${m}`}:{},body:r}),l=await g.json().catch(()=>({}));g.ok?(p("Image saved to Zuno!"),l.id&&u("POST","/api/ai/process-content",{content_id:l.id})):p((l==null?void 0:l.detail)||"Failed to save image",!0)}window.handleSharedContent=ho;mt();de()&&ao.addListener("appUrlOpen",async e=>{e.url&&e.url.includes("access_token")&&await Le(e.url)&&k()});function wo(e){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}window.addEventListener("hashchange",k);wo(async()=>{fo(),bo();const t=new URLSearchParams(window.location.search).get("share");if(t){try{sessionStorage.setItem("zuno_pending_share",t)}catch{}const a=new URL(window.location.href);a.searchParams.delete("share"),window.history.replaceState({},"",a.pathname+a.search+(a.hash||""))}await Le(),await k(),Je(),typeof window.lucide<"u"&&window.lucide.createIcons({nameAttr:"data-lucide"});const n=2e3;if(typeof hideSplash=="function"){const a=typeof window._splashStart=="number"?Date.now()-window._splashStart:0,o=Math.max(0,n-a);setTimeout(hideSplash,o)}});export{He as W,ce as _,fe as r};
