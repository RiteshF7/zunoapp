(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function n(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(o){if(o.ep)return;o.ep=!0;const s=n(o);fetch(o.href,s)}})();function pt(){const e=localStorage.getItem("zuno_theme")||"system";ve(e),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{(localStorage.getItem("zuno_theme")||"system")==="system"&&ve("system")})}function ve(e){localStorage.setItem("zuno_theme",e);const t=e==="dark"||e==="system"&&window.matchMedia("(prefers-color-scheme: dark)").matches;document.documentElement.classList.toggle("dark",t)}function ft(){return localStorage.getItem("zuno_theme")||"system"}window.applyTheme=ve;const Ze=typeof import.meta<"u"&&"https://orpdwhqgcthwjnbirizx.supabase.co"||typeof import.meta<"u"&&!1||"",gt=typeof import.meta<"u"&&"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ycGR3aHFnY3Rod2puYmlyaXp4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzA3MjUxMjAsImV4cCI6MjA4NjMwMTEyMH0.4RMhxpB6tTSDEKQfubST_TzPhsvx2Z1HT2juHZDD7qM"||typeof import.meta<"u"&&!1||"",bt="com.zuno.app",xt=`${bt}://callback`;function de(){return!!(window.Capacitor&&window.Capacitor.isNativePlatform&&window.Capacitor.isNativePlatform())}function Se(){var n,a,o,s;const e=typeof window<"u"&&((n=window.location)==null?void 0:n.hostname);return(e==="localhost"||e==="127.0.0.1")&&typeof window<"u"&&((a=window.location)!=null&&a.origin)?window.location.origin:e==="localhost"&&!((o=window.location)!=null&&o.port)?"http://10.0.2.2:8000":typeof import.meta<"u"&&"https://zunoapp.onrender.com"||typeof window<"u"&&window.ZUNO_API_BASE||typeof window<"u"&&((s=window.location)==null?void 0:s.origin)||""}function ht(){return!1}function vt(){return de()?xt:window.location.origin+window.location.pathname}function Je(){var a,o,s;if(typeof window>"u"||!((a=window.Capacitor)!=null&&a.getPlatform)||window.Capacitor.getPlatform()!=="ios")return;const e=localStorage.getItem("zuno_token");if(!e)return;const t=Se(),n=(s=(o=window.Capacitor)==null?void 0:o.Plugins)==null?void 0:s.ZunoAuthSync;n!=null&&n.syncToken&&n.syncToken({token:e,apiBase:t}).catch(()=>{})}function E(e){window.location.hash=e}function C(e){const t=e.startsWith("#")?e:"#"+e,n=new URL(window.location.href);n.hash=t,history.replaceState(null,"",n)}const yt=new Set(["auth","connect-extension","home","library","feed","collections","content-detail","collection","goals","goal-detail","search","knowledge","profile","admin"]);function wt(){const t=(window.location.hash||"").replace(/^#/,"").split("/"),n=(t[0]||"").trim().toLowerCase(),a=(t[1]||"").trim()||null;return{page:n&&yt.has(n)?n:"",id:a}}window.navigate=E;const kt="modulepreload",$t=function(e){return"/app/"+e},je={},ce=function(t,n,a){let o=Promise.resolve();if(n&&n.length>0){let i=function(m){return Promise.all(m.map(g=>Promise.resolve(g).then(l=>({status:"fulfilled",value:l}),l=>({status:"rejected",reason:l}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),c=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));o=i(n.map(m=>{if(m=$t(m),m in je)return;je[m]=!0;const g=m.endsWith(".css"),l=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${l}`))return;const f=document.createElement("link");if(f.rel=g?"stylesheet":kt,g||(f.as="script"),f.crossOrigin="",f.href=m,c&&f.setAttribute("nonce",c),document.head.appendChild(f),g)return new Promise((v,b)=>{f.addEventListener("load",v),f.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${m}`)))})}))}function s(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return o.then(i=>{for(const r of i||[])r.status==="rejected"&&s(r.reason);return t().catch(s)})};let V=null;function _t(e){return e.startsWith("/api/")&&!e.startsWith("/api/v1/")?"/api/v1"+e.slice(4):e}async function Ge(e,t,n,a){const o=localStorage.getItem("zuno_token"),s={};o&&(s.Authorization=`Bearer ${o}`);const i=_t(t);let c=`${Se()}${i}`;if(a){const v=new URLSearchParams;Object.entries(a).forEach(([_,h])=>{h!==""&&h!=null&&v.append(_,h)});const b=v.toString();b&&(c+="?"+b)}const m={method:e,headers:s};n&&["POST","PATCH","PUT","DELETE"].includes(e)&&(s["Content-Type"]="application/json",m.body=JSON.stringify(n));const g=await fetch(c,m),l=await g.text();let f;try{f=JSON.parse(l)}catch{f=l}return{ok:g.ok,status:g.status,data:f}}async function u(e,t,n=null,a=null){typeof window.showProgress=="function"&&window.showProgress();try{let o=await Ge(e,t,n,a);if(o.status===401&&(!!localStorage.getItem("zuno_refresh_token")&&await St()&&(o=await Ge(e,t,n,a)),o.status===401)){const r=window.location.hash||"#";if(r!=="#auth"&&r!=="#")try{sessionStorage.setItem("zuno_intended_route",r)}catch{}localStorage.removeItem("zuno_token"),localStorage.removeItem("zuno_refresh_token"),window.location.hash!=="#auth"&&(window.location.hash="#auth")}return o}catch(o){return{ok:!1,status:0,data:{error:o.message}}}finally{typeof window.hideProgress=="function"&&window.hideProgress()}}async function St(){return V||(V=(async()=>{try{const{refreshAccessToken:e}=await ce(async()=>{const{refreshAccessToken:t}=await Promise.resolve().then(()=>Rt);return{refreshAccessToken:t}},void 0);return await e()}catch{return!1}finally{V=null}})(),V)}let A=null;function Ce(e){A=e}function Re(e){const t=document.querySelector("#topnav .header-profile-btn"),n=document.getElementById("header-profile-avatar");!t||!n||(e?(n.style.backgroundImage=`url(${encodeURI(e)})`,n.classList.remove("hidden"),t.classList.add("has-avatar")):(n.style.backgroundImage="",n.classList.add("hidden"),t.classList.remove("has-avatar")))}async function Ct(e=!1){if(A&&!e)return Re(A.avatar_url||null),A;const t=await u("GET","/api/profile");return t.ok&&(A=t.data),Re((A==null?void 0:A.avatar_url)||null),A||{}}let ue="saved";function Ye(e){ue=e}let ie="summary";function Te(e){ie=e}let R="active";function Tt(e){R=e}let D=!1;function Et(e){D=e}let le=!1;function Lt(e){le=e}let U="fts";function Pt(e){U=e}let Y=[];function De(e){Y.push(e)}function At(){Y=[]}const It=["What topics appear most in my saved content?","Summarize my most recent saves","What are the key takeaways from my articles?","How are my saved items connected?"];let se=null;function Mt(e){se=e}const me=new Set;function Qe(e){me.add(e)}function I(e){me.delete(e)}function q(){return me}function Bt(e){return me.has(e)}function Z(e=3){return Array(e).fill(0).map(()=>`
  ...
  </svg>`}async function Dt(e){await u("PATCH","/api/user-preferences",{feed_type:e}),await k()}async function Ot(e,t){var a;const n=await u("POST",`/api/feed/bookmarks/${e}/toggle`);if(n.ok){const o=t.querySelector("span"),s=((a=n.data)==null?void 0:a.bookmarked)??!o.textContent.includes("border");o.textContent=s?"bookmark":"bookmark_border",o.classList.toggle("text-accent",s),o.classList.toggle("text-muted-foreground",!s),s?o.classList.add("bookmark-pop"):o.classList.remove("bookmark-pop")}}window.switchFeedType=Dt;window.toggleBookmark=Ot;const Ft=15,Fe=15,Ue={blue:"from-blue-500/20 to-blue-600/5 border-blue-500/20",green:"from-green-500/20 to-green-600/5 border-green-500/20",purple:"from-purple-500/20 to-purple-600/5 border-purple-500/20",amber:"from-amber-500/20 to-amber-600/5 border-amber-500/20",rose:"from-rose-500/20 to-rose-600/5 border-rose-500/20",indigo:"from-indigo-500/20 to-indigo-600/5 border-indigo-500/20"};function Ut(e){const t=Ue[e.theme]||Ue.blue;return`
    ...
    </article>`}async function zt(e){const[t,n,a]=await Promise.all([Ct(),u("GET","/api/collections"),u("GET","/api/content",null,{limit:Fe})]);n.ok||F(n),a.ok||F(a);const o=(t==null?void 0:t.display_name)||"there",i=(n.ok?Array.isArray(n.data)?n.data:[]:[]).slice(0,Ft),r=a.ok?a.data:null,m=(Array.isArray(r)?r:(r==null?void 0:r.items)??[]).slice(0,Fe),g=`
    <section class="mb-4" aria-label="Welcome">
      <h1 class="text-xl font-bold text-heading">Hi, ${d(o)}!</h1>
      <p class="text-muted-foreground text-sm mt-0.5">${Ht()}</p>
    </section>`,l=`
    ...
    </div>`}const ze={blue:"from-blue-500/20 to-blue-600/5 border-blue-500/20",green:"from-green-500/20 to-green-600/5 border-green-500/20",purple:"from-purple-500/20 to-purple-600/5 border-purple-500/20",amber:"from-amber-500/20 to-amber-600/5 border-amber-500/20",rose:"from-rose-500/20 to-rose-600/5 border-rose-500/20",indigo:"from-indigo-500/20 to-indigo-600/5 border-indigo-500/20"};function Wt(e,t){return`
    ${t.length>0?`
      <div class="mb-5">
  ...
  `}async function Kt(e){const[t,n]=await Promise.all([u("GET","/api/collections"),u("GET","/api/collections/categories")]);t.ok||F(t),n.ok||F(n);const a=t.ok?Array.isArray(t.data)?t.data:[]:[],o=n.ok?Array.isArray(n.data)?n.data:[]:[];e.innerHTML=`
    <div class="fade-in">
      <h1 class="text-xl font-bold text-heading mb-4">Collections</h1>
      ${Wt(a,o)}
    </div>`}async function Vt(){const e=document.getElementById("page");if(!e)return;const t=(window.location.hash||"").replace(/^#/,""),[n,a]=t.split("/"),o=document.getElementById("library-refresh-btn");if(o){o.disabled=!0;const s=o.querySelector(".material-icons-round");s&&s.classList.add("animate-spin")}if(n==="profile"&&a==="bookmarks"?await Ae(e,{standalone:!0,backHash:"#profile",backLabel:"Profile"}):await ot(e,ue),o){o.disabled=!1;const s=o.querySelector(".material-icons-round");s&&s.classList.remove("animate-spin")}}function Zt(e){Ye(e),E(e==="saved"?"#home":`#home/${e}`)}function we(e=""){return`
  ...
  `}function Yt(e=""){P(we(e))}async function Qt(e=null){const t=(window.location.hash||"").replace("#","");if(!((t==="home"||t==="home/saved")&&ue==="saved"))return;const a=await u("GET","/api/content",null,{limit:50});if(!a.ok)return;const o=a.data,s=Array.isArray(o)?o:(o==null?void 0:o.items)??[];s.forEach(r=>{r.ai_processed&&I(r.id)});const i=document.getElementById("content-list");if(i){const r=q();if(i.innerHTML=s.map(c=>{const m=e&&(c.id===e||(c.content_id||c.id)===e),g=Q(c,{showAiStatus:!0,processingIds:r,roundedMinimal:!0});return m?g.replace('<article class="','<article class="new-item-highlight '):g}).join(""),e){const c=i.querySelector(".new-item-highlight");c&&setTimeout(()=>c.classList.remove("new-item-highlight"),1500)}}else{const r=document.getElementById("page");r&&await Pe(r)}}async function Xt(){var a,o;const e=document.getElementById("m-url"),t=e?e.value.trim():"";if(!t){p("URL is required",!0);return}const n=document.getElementById("modal-content");n&&(n.innerHTML=Jt());try{const s=await u("POST","/api/content",{url:t});if(s.ok){const i=(a=s.data)==null?void 0:a.id;i&&(Qe(i),u("POST","/api/ai/process-content",{content_id:i}).catch(()=>{I(i),p("AI processing failed for this item",!0)})),K(),p("Link saved"),await Qt(i)}else n&&(n.innerHTML=we(t)),p(((o=s.data)==null?void 0:o.detail)||"Couldn't save link. Check the URL and try again.",!0)}catch{n&&(n.innerHTML=we(t)),p("Couldn't save link. Check the URL and try again.",!0)}}function en(){P(`
  ...
  `)}async function tn(){var o;const e=document.getElementById("c-title").value.trim();if(!e){p("Title is required",!0);return}const t=document.getElementById("create-col-btn");t.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',t.disabled=!0;const n={title:e,description:document.getElementById("c-desc").value.trim()||null,icon:document.getElementById("c-icon").value.trim()||"folder",theme:document.getElementById("c-theme").value},a=await u("POST","/api/collections",n);a.ok?(K(),p("Collection created!"),E("#collection/"+a.data.id)):(p(((o=a.data)==null?void 0:o.detail)||"Failed to create",!0),t.textContent="Create Collection",t.disabled=!1)}window.refreshLibrary=Vt;window.switchLibraryTab=Zt;window.openSaveContentModal=Yt;window.doSaveContent=Xt;window.openCreateCollectionModal=en;window.doCreateCollection=tn;function Ie(e,t,n="Confirm",a=!1){return new Promise(o=>{const s=document.getElementById("confirm-overlay");document.getElementById("confirm-content").innerHTML=`
    ...
    </div>`}function on(e,t){Te(e),j(document.getElementById("page"),t)}function an(e){P(`
  ...
  `)}async function sn(e){var t;Qe(e),await j(document.getElementById("page"),e),typeof showProgress=="function"&&showProgress();try{const n=await u("POST","/api/ai/process-content",{content_id:e});n.ok?n.status===202?p("AI processing started — refresh the list in a moment"):(I(e),p("AI processing complete!"),Te("summary"),await j(document.getElementById("page"),e)):(I(e),p(((t=n.data)==null?void 0:t.detail)||"AI processing failed",!0),await j(document.getElementById("page"),e))}catch{I(e),p("AI processing failed",!0),await j(document.getElementById("page"),e)}finally{typeof hideProgress=="function"&&hideProgress()}}async function rn(e){const t=await u("GET","/api/collections"),n=t.ok?Array.isArray(t.data)?t.data:[]:[];P(`
  ...
  `)}async function ln(e,t){var a;const n=await u("POST",`/api/collections/${e}/items`,{content_id:t});n.ok?(K(),p("Added to collection!")):p(((a=n.data)==null?void 0:a.detail)||"Failed to add",!0)}async function dn(e){const t=await u("GET",`/api/content/${e}`);if(!t.ok)return;const n=t.data;P(`
  ...
  `)}async function cn(e){var o;const t=document.getElementById("edit-btn");t.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',t.disabled=!0;const n={title:document.getElementById("e-title").value.trim()||null,description:document.getElementById("e-desc").value.trim()||null,url:document.getElementById("e-url").value.trim()||null},a=await u("PATCH",`/api/content/${e}`,n);a.ok?(K(),p("Content updated!"),await j(document.getElementById("page"),e)):(p(((o=a.data)==null?void 0:o.detail)||"Failed to update",!0),t.textContent="Save Changes",t.disabled=!1)}async function un(e){var a;if(!await Ie("Delete Content","This action cannot be undone. Are you sure?","Delete",!0))return;const n=await u("DELETE",`/api/content/${e}`);n.ok?(p("Deleted!"),E("#home")):p(((a=n.data)==null?void 0:a.detail)||"Failed to delete",!0)}window.switchContentTab=on;window.openContentActions=an;window.processWithAI=sn;window.openAddToCollectionModal=rn;window.addToCollection=ln;window.openEditContentModal=dn;window.doEditContent=cn;window.deleteContent=un;async function Me(e,t){if(!t){E("#collections");return}const[n,a]=await Promise.all([u("GET",`/api/collections/${t}`),u("GET",`/api/collections/${t}/items`)]);if(!n.ok){e.innerHTML='<div class="text-center py-16 fade-in"><span class="material-icons-round text-5xl text-muted-foreground/60 mb-3">error</span><p class="text-muted-foreground">Collection not found</p></div>';return}const o=n.data,s=a.ok?Array.isArray(a.data)?a.data:[]:[];e.innerHTML=`
    <div class="slide-in-right">
      <!-- Header -->
    ...
    </div>`}async function mn(e){const t=await u("GET","/api/content",null,{limit:50}),n=t.ok?Array.isArray(t.data)?t.data:[]:[];P(`
    <h2 class="text-lg font-bold text-heading mb-4">Add Content</h2>
  ...
  `)}async function pn(e,t){var a;const n=await u("DELETE",`/api/collections/${e}/items/${t}`);n.ok?(p("Removed from collection"),await Me(document.getElementById("page"),e)):p(((a=n.data)==null?void 0:a.detail)||"Failed to remove",!0)}async function fn(e){const t=await u("GET",`/api/collections/${e}`);if(!t.ok)return;const n=t.data;P(`
  ...
  `)}async function gn(e){var o;const t=document.getElementById("edit-col-btn");t.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',t.disabled=!0;const n={title:document.getElementById("ec-title").value.trim()||null,description:document.getElementById("ec-desc").value.trim()||null,is_shared:document.getElementById("ec-shared").checked},a=await u("PATCH",`/api/collections/${e}`,n);a.ok?(K(),p("Collection updated!"),await Me(document.getElementById("page"),e)):(p(((o=a.data)==null?void 0:o.detail)||"Failed to update",!0),t.textContent="Save Changes",t.disabled=!1)}async function bn(e){var a;if(!await Ie("Delete Collection","This will remove the collection but not its content. Continue?","Delete",!0))return;const n=await u("DELETE",`/api/collections/${e}`);n.ok?(p("Deleted!"),E("#collections")):p(((a=n.data)==null?void 0:a.detail)||"Failed to delete",!0)}window.openAddContentToCollectionModal=mn;window.removeFromCollection=pn;window.openEditCollectionModal=fn;window.doEditCollection=gn;window.deleteCollection=bn;async function X(e){const[t,n]=await Promise.all([u("GET","/api/goals",null,{status:R}),R==="active"?u("GET","/api/goals/suggestions",null,{status:"pending"}):Promise.resolve({ok:!0,data:[]})]),a=t.ok?Array.isArray(t.data)?t.data:[]:[],o=n.ok?Array.isArray(n.data)?n.data:[]:[],s=a.filter(l=>!l.parent_goal_id),i={};a.filter(l=>l.parent_goal_id).forEach(l=>{i[l.parent_goal_id]||(i[l.parent_goal_id]=[]),i[l.parent_goal_id].push(l)});const r=a.flatMap(l=>l.steps||[]),c=r.length,m=r.filter(l=>l.is_completed).length,g=c>0?Math.round(m/c*100):0;e.innerHTML=`
    <div class="fade-in">
      ...
      ${o.length>0?`
        ...
        ${D?`<div class="space-y-3 mb-4">${o.map(hn).join("")}</div>`:""}
      `:""}
      ...
      ${s.length===0&&o.length===0?`
        ...
        <div class="space-y-3">
          ${s.map(l=>xn(l,i[l.id]||[])).join("")}
        </div>`}
    </div>`}function xn(e,t=[]){const n=Math.round((e.confidence||0)*100),a=(e.evidence_content_ids||[]).length,o=t.length>0,s=e.steps||[],i=s.filter(l=>l.is_completed).length,r=s.length,c=r>0?Math.round(i/r*100):0,g={active:"border-l-accent",completed:"border-l-success",dismissed:"border-l-muted"}[e.status]||"border-l-accent";return`
    ...
    </article>`}function hn(e){const t=(e.child_goal_ids||[]).length;return`
    ...
    </div>`}function vn(){Et(!D),X(document.getElementById("page"))}function yn(){P(`
  ...
  `)}async function wn(e){var a,o;const t=document.getElementById("accept-"+e);t&&(t.innerHTML='<div class="spinner" style="width:14px;height:14px;border-width:2px;"></div>',t.disabled=!0);const n=await u("POST",`/api/goals/suggestions/${e}/accept`);n.ok?(p(((a=n.data)==null?void 0:a.message)||"Goals merged!"),X(document.getElementById("page"))):(p(((o=n.data)==null?void 0:o.detail)||"Failed to merge",!0),t&&(t.textContent="Accept",t.disabled=!1))}async function kn(e){var a;const t=document.getElementById("dismiss-"+e);t&&(t.innerHTML='<div class="spinner" style="width:14px;height:14px;border-width:2px;"></div>',t.disabled=!0);const n=await u("POST",`/api/goals/suggestions/${e}/dismiss`);n.ok?(p("Suggestion dismissed"),X(document.getElementById("page"))):(p(((a=n.data)==null?void 0:a.detail)||"Failed to dismiss",!0),t&&(t.textContent="Dismiss",t.disabled=!1))}async function $n(){var t,n;p("Starting consolidation...");const e=await u("POST","/api/goals/consolidate");e.ok?p(((t=e.data)==null?void 0:t.message)||"Finding similar goals…"):p(((n=e.data)==null?void 0:n.detail)||"Couldn't find goals to combine",!0)}async function _n(){var t,n;p("Refreshing goals…");const e=await u("POST","/api/goals/reanalyze");e.ok?p(((t=e.data)==null?void 0:t.message)||"Goals refreshed!"):p(((n=e.data)==null?void 0:n.detail)||"Refresh failed",!0)}function Sn(e){Tt(e),X(document.getElementById("page"))}window.setGoalsFilterAndRender=Sn;window.toggleSuggestions=vn;window.openGoalsMenu=yn;window.acceptSuggestion=wn;window.dismissSuggestion=kn;window.triggerConsolidate=$n;window.reanalyzeGoals=_n;async function pe(e,t){if(!t){E("#goals");return}const n=await u("GET",`/api/goals/${t}`);if(!n.ok){e.innerHTML='<div class="text-center py-16 fade-in"><span class="material-icons-round text-5xl text-muted-foreground/60 mb-3">error</span><p class="text-muted-foreground">Goal not found</p></div>';return}const a=n.data,o=a.steps||[],s=o.filter(y=>y.is_completed),i=o.filter(y=>!y.is_completed),r=s.length,c=o.length,m=c>0?Math.round(r/c*100):0,g=Math.round((a.confidence||0)*100),l=(a.evidence_content_ids||[]).length,f=a.children||[],v=f.length>0,b=!!a.parent_goal_id,h=`hsl(${getComputedStyle(document.documentElement).getPropertyValue("--primary").trim()})`;e.innerHTML=`
    <div class="slide-in-right">
      <!-- Header -->
      <div class="flex items-center gap-3 mb-4">
    ...
    </div>`}function Cn(e){Lt(!le),pe(document.getElementById("page"),e)}async function Tn(e,t,n){var o;const a=await u("PATCH",`/api/goals/${e}/steps/${t}`,{is_completed:n});a.ok?await pe(document.getElementById("page"),e):p(((o=a.data)==null?void 0:o.detail)||"Failed to update step",!0)}async function En(e,t){var a;const n=await u("PATCH",`/api/goals/${e}`,{status:t});n.ok?(p(`Goal ${t==="completed"?"completed":t==="dismissed"?"dismissed":"reactivated"}!`),await pe(document.getElementById("page"),e)):p(((a=n.data)==null?void 0:a.detail)||"Failed to update goal",!0)}async function Ln(e){var a;if(!await Ie("Delete Goal","This will delete the goal and all its steps. Continue?","Delete",!0))return;const n=await u("DELETE",`/api/goals/${e}`);n.ok?(p("Goal deleted"),E("#goals")):p(((a=n.data)==null?void 0:a.detail)||"Failed to delete",!0)}window.toggleCompletedSteps=Cn;window.toggleGoalStep=Tn;window.updateGoalStatus=En;window.deleteGoal=Ln;function at(){try{return JSON.parse(localStorage.getItem("zuno_searches")||"[]")}catch{return[]}}function Pn(e){const t=at().filter(n=>n!==e);t.unshift(e),localStorage.setItem("zuno_searches",JSON.stringify(t.slice(0,5)))}async function An(e){const t=await u("GET","/api/tags/popular"),n=t.ok?Array.isArray(t.data)?t.data:[]:[],a=at();e.innerHTML=`
    <div class="fade-in">
      <!-- Search Input -->
  ...
  `)}async function Hn(){var t;p("Updating knowledge base...");const e=await u("POST","/api/knowledge/reindex",{});e.ok?p(`Updated: ${e.data.content_processed} items in your knowledge base`):p(((t=e.data)==null?void 0:t.detail)||"Update failed",!0)}function jn(){At(),it(document.getElementById("page"))}window.askSuggested=Mn;window.doAsk=lt;window.openKnowledgeSettings=Bn;window.doReindex=Hn;window.clearKnowledgeAndRender=jn;async function Be(e){var c;const[t,n,a]=await Promise.all([u("GET","/api/profile"),u("GET","/api/user-preferences"),u("GET","/api/admin/me")]),o=t.ok?t.data:{},s=n.ok?n.data:{},i=ft(),r=a.ok&&((c=a.data)==null?void 0:c.admin)===!0;e.innerHTML=`
    <div class="fade-in">
      <!-- Avatar Hero -->
    ...
    </div>`}async function Gn(){var a;const e=document.getElementById("profile-btn");e.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',e.disabled=!0;const t={display_name:document.getElementById("p-name").value.trim()||null,avatar_url:document.getElementById("p-avatar").value.trim()||null},n=await u("PATCH","/api/profile",t);n.ok?(Ce(null),p("Profile updated!")):p(((a=n.data)==null?void 0:a.detail)||"Failed to update",!0),e.textContent="Update Profile",e.disabled=!1}async function Rn(e){await u("PATCH","/api/user-preferences",{feed_type:e}),p("Feed preference updated!"),await Be(document.getElementById("page"))}window.renderProfile=Be;window.doUpdateProfile=Gn;window.updateFeedPref=Rn;async function dt(e){var n;const t=await u("GET","/api/admin/me");if(!t.ok||!((n=t.data)!=null&&n.admin)){E("#profile");return}e.innerHTML=`
    <div class="fade-in">
      <div class="flex items-center gap-3 mb-5">
  ...
  `,e.innerHTML='<span class="material-icons-round text-base">list</span> Load waitlist',e.disabled=!1}function Wn(){if($e.length===0)return;const e=["email","tier","discount_code","created_at"],t=[e.join(",")].concat($e.map(o=>e.map(s=>`"${String(o[s]||"").replace(/"/g,'""')}"`).join(","))).join(`
`),n=new Blob([t],{type:"text/csv;charset=utf-8"}),a=document.createElement("a");a.href=URL.createObjectURL(n),a.download=`zuno-waitlist-${new Date().toISOString().slice(0,10)}.csv`,a.click(),URL.revokeObjectURL(a.href)}window.renderAdmin=dt;window.adminLoadCacheStats=Dn;window.adminDoBustCache=On;window.adminDoReloadPrompts=Fn;window.adminDoGenerateEmbedding=Un;window.adminDoGenerateFeed=zn;window.adminDoHealthCheck=Nn;window.adminLoadWaitlist=qn;window.adminExportWaitlistCsv=Wn;const ae=["content-detail","collection","goal-detail"];let S=0;function Kn(e){return se?ae.includes(e)&&!ae.includes(se)?"slide-in-right":ae.includes(se)&&!ae.includes(e)?"slide-in-left":"fade-in":"fade-in"}function Vn(e){if(typeof document.startViewTransition=="function")return document.startViewTransition(e);const t=e();return t&&typeof t.then=="function"?t.then(()=>{}):Promise.resolve()}async function k(){var g;const e=++S,t=localStorage.getItem("zuno_token");let{page:n,id:a}=wt();if(!n){C(t?"#home":"#auth"),queueMicrotask(()=>k());return}if(n==="collection"&&!a){C("#collections"),queueMicrotask(()=>k());return}if(!t&&n!=="auth"&&n!=="connect-extension"){C("#auth"),queueMicrotask(()=>k());return}if(t&&n==="auth"){C("#home"),queueMicrotask(()=>k());return}const o=document.getElementById("page");if(!o)return;if(n==="connect-extension"){try{window.ZUNO_API_BASE=Se()}catch{window.ZUNO_API_BASE=((g=window.location)==null?void 0:g.origin)||""}o.innerHTML=`<div class="flex flex-col items-center justify-center py-16 text-center fade-in">
      ...
      <p class="text-muted-foreground text-sm">Make sure you're logged in. If nothing happens, ensure the Share to Zuno extension is installed.</p>
        ...
        </div>`}}})}finally{typeof window.hideProgress=="function"&&window.hideProgress()}}window.router=k;/*! Capacitor: https://capacitorjs.com/ - MIT License */var W;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(W||(W={}));class he extends Error{constructor(t,n,a){super(t),this.message=t,this.code=n,this.data=a}}const Zn=e=>{var t,n;return e!=null&&e.androidBridge?"android":!((n=(t=e==null?void 0:e.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||n===void 0)&&n.bridge?"ios":"web"},Jn=e=>{const t=e.CapacitorCustomPlatform||null,n=e.Capacitor||{},a=n.Plugins=n.Plugins||{},o=()=>t!==null?t.name:Zn(e),s=()=>o()!=="web",i=l=>{const f=m.get(l);return!!(f!=null&&f.platforms.has(o())||r(l))},r=l=>{var f;return(f=n.PluginHeaders)===null||f===void 0?void 0:f.find(v=>v.name===l)},c=l=>e.console.error(l),m=new Map,g=(l,f={})=>{const v=m.get(l);if(v)return console.warn(`Capacitor plugin "${l}" already registered. Cannot register plugins twice.`),v.proxy;const b=o(),_=r(l);let h;const y=async()=>(!h&&b in f?h=typeof f[b]=="function"?h=await f[b]():h=f[b]:t!==null&&!h&&"web"in f&&(h=typeof f.web=="function"?h=await f.web():h=f.web),h),ge=(w,$)=>{var L,B;if(_){const H=_==null?void 0:_.methods.find(T=>$===T.name);if(H)return H.rtype==="promise"?T=>n.nativePromise(l,$.toString(),T):(T,ne)=>n.nativeCallback(l,$.toString(),T,ne);if(w)return(L=w[$])===null||L===void 0?void 0:L.bind(w)}else{if(w)return(B=w[$])===null||B===void 0?void 0:B.bind(w);throw new he(`"${l}" plugin is not implemented on ${b}`,W.Unimplemented)}},M=w=>{let $;const L=(...B)=>{const H=y().then(T=>{const ne=ge(T,w);if(ne){const oe=ne(...B);return $=oe==null?void 0:oe.remove,oe}else throw new he(`"${l}.${w}()" is not implemented on ${b}`,W.Unimplemented)});return w==="addListener"&&(H.remove=async()=>$()),H};return L.toString=()=>`${w.toString()}() { [capacitor code] }`,Object.defineProperty(L,"name",{value:w,writable:!1,configurable:!1}),L},ee=M("addListener"),te=M("removeListener"),mt=(w,$)=>{const L=ee({eventName:w},$),B=async()=>{const T=await L;te({eventName:w,callbackId:T},$)},H=new Promise(T=>L.then(()=>T({remove:B})));return H.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await B()},H},be=new Proxy({},{get(w,$){switch($){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return _?mt:ee;case"removeListener":return te;default:return M($)}}});return a[l]=be,m.set(l,{name:l,proxy:be,platforms:new Set([...Object.keys(f),..._?[b]:[]])}),be};return n.convertFileSrc||(n.convertFileSrc=l=>l),n.getPlatform=o,n.handleError=c,n.isNativePlatform=s,n.isPluginAvailable=i,n.registerPlugin=g,n.Exception=he,n.DEBUG=!!n.DEBUG,n.isLoggingEnabled=!!n.isLoggingEnabled,n},Yn=e=>e.Capacitor=Jn(e),_e=Yn(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),fe=_e.registerPlugin;class He{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,n){let a=!1;this.listeners[t]||(this.listeners[t]=[],a=!0),this.listeners[t].push(n);const s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),a&&this.sendRetainedArgumentsForEvent(t);const i=async()=>this.removeListener(t,n);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,n,a){const o=this.listeners[t];if(!o){if(a){let s=this.retainedEventArguments[t];s||(s=[]),s.push(n),this.retainedEventArguments[t]=s}return}o.forEach(s=>s(n))}hasListeners(t){var n;return!!(!((n=this.listeners[t])===null||n===void 0)&&n.length)}registerWindowListener(t,n){this.windowListeners[n]={registered:!1,windowEventName:t,pluginEventName:n,handler:a=>{this.notifyListeners(n,a)}}}unimplemented(t="not implemented"){return new _e.Exception(t,W.Unimplemented)}unavailable(t="not available"){return new _e.Exception(t,W.Unavailable)}async removeListener(t,n){const a=this.listeners[t];if(!a)return;const o=a.indexOf(n);this.listeners[t].splice(o,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const n=this.retainedEventArguments[t];n&&(delete this.retainedEventArguments[t],n.forEach(a=>{this.notifyListeners(t,a)}))}}const qe=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),We=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Qn extends He{async getCookies(){const t=document.cookie,n={};return t.split(";").forEach(a=>{if(a.length<=0)return;let[o,s]=a.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");o=We(o).trim(),s=We(s).trim(),n[o]=s}),n}async setCookie(t){try{const n=qe(t.key),a=qe(t.value),o=`; expires=${(t.expires||"").replace("expires=","")}`,s=(t.path||"/").replace("path=",""),i=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${n}=${a||""}${o}; path=${s}; ${i};`}catch(n){return Promise.reject(n)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(n){return Promise.reject(n)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const n of t)document.cookie=n.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}fe("CapacitorCookies",{web:()=>new Qn});const Xn=async e=>new Promise((t,n)=>{const a=new FileReader;a.onload=()=>{const o=a.result;t(o.indexOf(",")>=0?o.split(",")[1]:o)},a.onerror=o=>n(o),a.readAsDataURL(e)}),eo=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(o=>o.toLocaleLowerCase()).reduce((o,s,i)=>(o[s]=e[t[i]],o),{})},to=(e,t=!0)=>e?Object.entries(e).reduce((a,o)=>{const[s,i]=o;let r,c;return Array.isArray(i)?(c="",i.forEach(m=>{r=t?encodeURIComponent(m):m,c+=`${s}=${r}&`}),c.slice(0,-1)):(r=t?encodeURIComponent(i):i,c=`${s}=${r}`),`${a}&${c}`},"").substr(1):null,no=(e,t={})=>{const n=Object.assign({method:e.method||"GET",headers:e.headers},t),o=eo(e.headers)["content-type"]||"";if(typeof e.data=="string")n.body=e.data;else if(o.includes("application/x-www-form-urlencoded")){const s=new URLSearchParams;for(const[i,r]of Object.entries(e.data||{}))s.set(i,r);n.body=s.toString()}else if(o.includes("multipart/form-data")||e.data instanceof FormData){const s=new FormData;if(e.data instanceof FormData)e.data.forEach((r,c)=>{s.append(c,r)});else for(const r of Object.keys(e.data))s.append(r,e.data[r]);n.body=s;const i=new Headers(n.headers);i.delete("content-type"),n.headers=i}else(o.includes("application/json")||typeof e.data=="object")&&(n.body=JSON.stringify(e.data));return n};class oo extends He{async request(t){const n=no(t,t.webFetchExtra),a=to(t.params,t.shouldEncodeUrlParams),o=a?`${t.url}?${a}`:t.url,s=await fetch(o,n),i=s.headers.get("content-type")||"";let{responseType:r="text"}=s.ok?t:{};i.includes("application/json")&&(r="json");let c,m;switch(r){case"arraybuffer":case"blob":m=await s.blob(),c=await Xn(m);break;case"json":c=await s.json();break;case"document":case"text":default:c=await s.text()}const g={};return s.headers.forEach((l,f)=>{g[f]=l}),{data:c,headers:g,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}fe("CapacitorHttp",{web:()=>new oo});var Ke;(function(e){e.Dark="DARK",e.Light="LIGHT",e.Default="DEFAULT"})(Ke||(Ke={}));var Ve;(function(e){e.StatusBar="StatusBar",e.NavigationBar="NavigationBar"})(Ve||(Ve={}));class ao extends He{async setStyle(){this.unavailable("not available for web")}async setAnimation(){this.unavailable("not available for web")}async show(){this.unavailable("not available for web")}async hide(){this.unavailable("not available for web")}}fe("SystemBars",{web:()=>new ao});const so=fe("App",{web:()=>ce(()=>import("./web-BIHpZYzB.js"),[]).then(e=>new e.AppWeb)}),ro=80,io=200;let x=null,z=!1,N=0,J=null,G=null,ct=0;function lo(){return x||(x=document.createElement("div"),x.id="global-loading-bar",x.setAttribute("role","progressbar"),x.setAttribute("aria-label","Loading"),x.setAttribute("aria-hidden","true"),x.className="global-loading-bar hidden",x.innerHTML='<div class="global-loading-bar-inner"></div>',document.body.appendChild(x),x)}function co(){!x||z||(G&&(clearTimeout(G),G=null),x.classList.remove("hidden"),x.setAttribute("aria-hidden","false"),z=!0,ct=Date.now())}function uo(){if(!x)return;const e=Date.now()-ct,t=Math.max(0,io-e);t>0&&z?G=setTimeout(()=>{G=null,x.classList.add("hidden"),x.setAttribute("aria-hidden","true"),z=!1},t):(x.classList.add("hidden"),x.setAttribute("aria-hidden","true"),z=!1)}function mo(){N++,lo(),N===1&&(G&&(clearTimeout(G),G=null),J=setTimeout(()=>{J=null,N>0&&co()},ro))}function po(){N>0&&N--,N===0&&(J&&(clearTimeout(J),J=null),z&&uo())}window.showProgress=mo;window.hideProgress=po;function fo(){const e=document.createElement("header");e.id="topnav",e.setAttribute("role","banner"),e.className="hidden sticky top-0 z-30 bg-transparent px-5 py-3 flex items-center justify-between safe-top mt-4";const t=typeof import.meta<"u"&&"/app/"||"/app/";return e.innerHTML=`
  ...
  `,e}function go(e){const t=document.getElementById("app-header-root");if(!t)return null;const n=fo();return t.appendChild(n),n}function bo(){const e=document.createElement("nav");return e.id="bottomnav",e.setAttribute("role","navigation"),e.setAttribute("aria-label","Main navigation"),e.className="hidden fixed bottom-0 left-0 right-0 border-t border-border px-6 py-4 z-30 safe-bottom",e.innerHTML=`
  ...
  `,e}function xo(e){const t=document.getElementById("bottom-nav-root");if(!t)return null;const n=bo();return t.appendChild(n),n}const ho=/https?:\/\/[^\s)<>]+/i;async function vo(e){if(!e||!e.content)return;if(!localStorage.getItem("zuno_token")){p("Please log in to save shared content",!0);return}try{typeof showProgress=="function"&&showProgress();try{e.type==="text"?await yo(e.content):e.type==="image"&&await wo(e.content,e.mimeType||"image/jpeg")}finally{typeof hideProgress=="function"&&hideProgress()}}catch(n){console.error("[ShareHandler]",n),p("Failed to save shared content",!0),typeof hideProgress=="function"&&hideProgress()}}async function yo(e){var n,a;const t=e.match(ho);if(t){const o=t[0],s=await u("POST","/api/content",{url:o});s.ok?(p("Saved to Zuno!"),u("POST","/api/ai/process-content",{content_id:s.data.id})):p(((n=s.data)==null?void 0:n.detail)||"Failed to save link",!0)}else{const o=e.length>80?e.slice(0,77)+"...":e,s=await u("POST","/api/content/text",{title:o,source_text:e});s.ok?p("Note saved to Zuno!"):p(((a=s.data)==null?void 0:a.detail)||"Failed to save note",!0)}}async function wo(e,t){const n=atob(e),a=new Uint8Array(n.length);for(let f=0;f<n.length;f++)a[f]=n.charCodeAt(f);const o=new Blob([a],{type:t}),s=t.split("/")[1]||"jpg",i=`shared_${Date.now()}.${s}`,r=new FormData;r.append("file",o,i);const c=window.ZUNO_API_BASE||(window.location.hostname==="localhost"&&!window.location.port?"http://10.0.2.2:8000":window.location.origin),m=localStorage.getItem("zuno_token"),g=await fetch(`${c}/api/v1/content/upload`,{method:"POST",headers:m?{Authorization:`Bearer ${m}`}:{},body:r}),l=await g.json().catch(()=>({}));g.ok?(p("Image saved to Zuno!"),l.id&&u("POST","/api/ai/process-content",{content_id:l.id})):p((l==null?void 0:l.detail)||"Failed to save image",!0)}window.handleSharedContent=vo;pt();de()&&so.addListener("appUrlOpen",async e=>{e.url&&e.url.includes("access_token")&&await Le(e.url)&&k()});function ut(e){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}window.addEventListener("hashchange",k);const ko=2e3,$o=4e3;function _o(){const e=typeof window.hideSplash=="function"?window.hideSplash:typeof hideSplash=="function"?hideSplash:null;if(!e)return;const t=typeof window._splashStart=="number"?Date.now()-window._splashStart:0,n=Math.max(0,ko-t);setTimeout(e,n)}ut(()=>{const e=typeof window.hideSplash=="function"?window.hideSplash:typeof hideSplash=="function"?hideSplash:null;e&&setTimeout(e,$o)});ut(async()=>{go(),xo();const t=new URLSearchParams(window.location.search).get("share");if(t){try{sessionStorage.setItem("zuno_pending_share",t)}catch{}const n=new URL(window.location.href);n.searchParams.delete("share"),window.history.replaceState({},"",n.pathname+n.search+(n.hash||""))}try{await Le(),await k(),Je(),typeof window.lucide<"u"&&window.lucide.createIcons({nameAttr:"data-lucide"})}finally{_o()}});export{He as W,ce as _,fe as r};
