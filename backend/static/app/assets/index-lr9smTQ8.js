(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();function Fe(){const e=localStorage.getItem("zuno_theme")||"system";ae(e),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{(localStorage.getItem("zuno_theme")||"system")==="system"&&ae("system")})}function ae(e){localStorage.setItem("zuno_theme",e);const t=e==="dark"||e==="system"&&window.matchMedia("(prefers-color-scheme: dark)").matches;document.documentElement.classList.toggle("dark",t)}function Ue(){return localStorage.getItem("zuno_theme")||"system"}window.applyTheme=ae;const Se=typeof import.meta<"u"&&"https://orpdwhqgcthwjnbirizx.supabase.co"||typeof import.meta<"u"&&!1||"",ze=typeof import.meta<"u"&&"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ycGR3aHFnY3Rod2puYmlyaXp4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzA3MjUxMjAsImV4cCI6MjA4NjMwMTEyMH0.4RMhxpB6tTSDEKQfubST_TzPhsvx2Z1HT2juHZDD7qM"||typeof import.meta<"u"&&!1||"",Ne="com.zuno.app",qe=`${Ne}://callback`;function Z(){return!!(window.Capacitor&&window.Capacitor.isNativePlatform&&window.Capacitor.isNativePlatform())}function Ke(){var e,t,n;return typeof import.meta<"u"&&"https://zunoapp.onrender.com"||typeof window<"u"&&window.ZUNO_API_BASE||(typeof window<"u"&&((e=window.location)==null?void 0:e.hostname)==="localhost"&&!((t=window.location)!=null&&t.port)?"http://10.0.2.2:8000":typeof window<"u"&&((n=window.location)==null?void 0:n.origin)||"")}function We(){return Z()?qe:window.location.origin+window.location.pathname}function Te(){var s,a,o;if(typeof window>"u"||!((s=window.Capacitor)!=null&&s.getPlatform)||window.Capacitor.getPlatform()!=="ios")return;const e=localStorage.getItem("zuno_token");if(!e)return;const t=Ke(),n=(o=(a=window.Capacitor)==null?void 0:a.Plugins)==null?void 0:o.ZunoAuthSync;n!=null&&n.syncToken&&n.syncToken({token:e,apiBase:t}).catch(()=>{})}function b(e){window.location.hash=e}function Je(){const t=(window.location.hash||"#auth").replace("#","").split("/");return{page:t[0],id:t[1]||null}}window.navigate=b;const Ze="modulepreload",Ve=function(e){return"/app/"+e},be={},V=function(t,n,s){let a=Promise.resolve();if(n&&n.length>0){let i=function(m){return Promise.all(m.map(f=>Promise.resolve(f).then(l=>({status:"fulfilled",value:l}),l=>({status:"rejected",reason:l}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),p=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));a=i(n.map(m=>{if(m=Ve(m),m in be)return;be[m]=!0;const f=m.endsWith(".css"),l=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${l}`))return;const x=document.createElement("link");if(x.rel=f?"stylesheet":Ze,f||(x.as="script"),x.crossOrigin="",x.href=m,p&&x.setAttribute("nonce",p),document.head.appendChild(x),f)return new Promise((y,h)=>{x.addEventListener("load",y),x.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${m}`)))})}))}function o(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return a.then(i=>{for(const r of i||[])r.status==="rejected"&&o(r.reason);return t().catch(o)})},Ye=typeof import.meta<"u"&&"https://zunoapp.onrender.com"||window.ZUNO_API_BASE||(window.location.hostname==="localhost"&&!window.location.port?"http://10.0.2.2:8000":window.location.origin);let H=null;function Qe(e){return e.startsWith("/api/")&&!e.startsWith("/api/v1/")?"/api/v1"+e.slice(4):e}async function he(e,t,n,s){const a=localStorage.getItem("zuno_token"),o={};a&&(o.Authorization=`Bearer ${a}`);const i=Qe(t);let r=`${Ye}${i}`;if(s){const x=new URLSearchParams;Object.entries(s).forEach(([h,k])=>{k!==""&&k!=null&&x.append(h,k)});const y=x.toString();y&&(r+="?"+y)}const p={method:e,headers:o};n&&["POST","PATCH","PUT","DELETE"].includes(e)&&(o["Content-Type"]="application/json",p.body=JSON.stringify(n));const m=await fetch(r,p),f=await m.text();let l;try{l=JSON.parse(f)}catch{l=f}return{ok:m.ok,status:m.status,data:l}}async function d(e,t,n=null,s=null){try{let a=await he(e,t,n,s);return a.status===401&&(localStorage.getItem("zuno_refresh_token")&&await Xe()&&(a=await he(e,t,n,s)),a.status===401&&(localStorage.removeItem("zuno_token"),localStorage.removeItem("zuno_refresh_token"),window.location.hash!=="#auth"&&(window.location.hash="#auth"))),a}catch(a){return{ok:!1,status:0,data:{error:a.message}}}}async function Xe(){return H||(H=(async()=>{try{const{refreshAccessToken:e}=await V(async()=>{const{refreshAccessToken:t}=await Promise.resolve().then(()=>dt);return{refreshAccessToken:t}},void 0);return await e()}catch{return!1}finally{H=null}})(),H)}let G=null;function le(e){G=e}async function et(e=!1){if(G&&!e)return G;const t=await d("GET","/api/profile");return t.ok&&(G=t.data),G||{}}let Ee="saved";function Pe(e){Ee=e}let W="summary";function Le(e){W=e}let E="active";function tt(e){E=e}let P=!1;function nt(e){P=e}let J=!1;function st(e){J=e}let I="fts";function at(e){I=e}let R=[];function ve(e){R.push(e)}function ot(){R=[]}const it=["What topics appear most in my saved content?","Summarize my most recent saves","What are the key takeaways from my articles?","How are my saved items connected?"];let q=null;function rt(e){q=e}function K(e=3){return Array(e).fill(0).map(()=>`
    ...
    </div>`}async function lt(){const e=We(),t=`${Se}/auth/v1/authorize?provider=google&redirect_to=${encodeURIComponent(e)}`;if(Z())try{const{Browser:n}=await V(async()=>{const{Browser:s}=await import("./index-CWu4gRpw.js");return{Browser:s}},[]);await n.open({url:t,windowName:"_system"})}catch{window.open(t,"_system")}else window.location.href=t}async function ce(e){let t;if(e){const i=e.indexOf("#");t=i>=0?e.substring(i+1):""}else{const i=window.location.hash;t=i?i.substring(1):""}if(!t||!t.includes("access_token="))return!1;const n=new URLSearchParams(t),s=n.get("access_token"),a=n.get("refresh_token");if(!s)return!1;if(localStorage.setItem("zuno_token",s),a&&localStorage.setItem("zuno_refresh_token",a),Z())try{const{Browser:i}=await V(async()=>{const{Browser:r}=await import("./index-CWu4gRpw.js");return{Browser:r}},[]);await i.close()}catch{}history.replaceState(null,"",window.location.pathname+"#home");const o=await d("GET","/api/profile");return o.ok?(le(o.data),Te(),u("Signed in as "+(o.data.display_name||o.data.email||"user")),!0):(localStorage.removeItem("zuno_token"),localStorage.removeItem("zuno_refresh_token"),history.replaceState(null,"",window.location.pathname+"#auth"),u("Sign-in failed. Please try again.","error"),!1)}async function ct(){const e=localStorage.getItem("zuno_refresh_token");if(!e)return!1;try{const t=await fetch(`${Se}/auth/v1/token?grant_type=refresh_token`,{method:"POST",headers:{"Content-Type":"application/json",apikey:ze},body:JSON.stringify({refresh_token:e})});if(!t.ok)return!1;const n=await t.json();return n.access_token?(localStorage.setItem("zuno_token",n.access_token),n.refresh_token&&localStorage.setItem("zuno_refresh_token",n.refresh_token),!0):!1}catch{return!1}}function Ie(){localStorage.removeItem("zuno_token"),localStorage.removeItem("zuno_refresh_token"),le(null),b("#auth"),u("Signed out")}window.doLogout=Ie;window.doGoogleLogin=lt;const dt=Object.freeze(Object.defineProperty({__proto__:null,doLogout:Ie,handleOAuthCallback:ce,refreshAccessToken:ct,renderAuth:Ae},Symbol.toStringTag,{value:"Module"}));function c(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}function de(e,t=100){return e&&e.length>t?e.slice(0,t)+"...":e||""}function ut(){const e=new Date().getHours();return e<12?"Good morning":e<18?"Good afternoon":"Good evening"}function pt(){return new Date().toLocaleDateString("en-US",{weekday:"long",month:"short",day:"numeric"})}function L(e,t="indigo"){return e?`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-semibold bg-${t}-500/15 text-${t}-600 dark:text-${t}-400">${c(e)}</span>`:""}function oe(e){return{youtube:"play_circle",instagram:"camera_alt",x:"tag",reddit:"forum",tiktok:"music_note",spotify:"headphones",web:"language"}[e]||"link"}function ue(e,t={}){const n=e.content_id||e.id,s=e.title||e.url||"Untitled",a=e.description||e.ai_summary||"",o=e.image_url||e.thumbnail_url,i=e.category||e.ai_category,r=e.platform,p=t.showBookmark||!1,m=t.isBookmarked||!1,f=t.showAiStatus||!1,l=e.ai_processed;return`
      ...
      <div class="flex gap-3">
        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="flex items-center gap-2 mt-2 flex-wrap">
            ...
            ${f?l?'<span class="text-success text-[10px] flex items-center gap-0.5"><span class="material-icons-round text-xs">check_circle</span>AI</span>':'<span class="text-muted text-[10px]">Pending</span>':""}
          </div>
        </div>
      </div>
    </article>`}function Be(e,t=48,n=4,s="#6366f1"){const a=(t-n)/2,o=2*Math.PI*a,i=o-o*e/100;return`<svg width="${t}" height="${t}" viewBox="0 0 ${t} ${t}" class="transform -rotate-90">
  ...
  </svg>`}async function mt(e){const t=await et(),n=await d("GET","/api/user-preferences"),s=n.ok?n.data.feed_type:"usersaved",a=s==="suggestedcontent"?"/api/suggested-feed":"/api/feed",[o,i]=await Promise.all([d("GET",a,null,{limit:30}),d("GET","/api/bookmarks")]),r=o.ok?Array.isArray(o.data)?o.data:o.data.items||[]:[],p=i.ok?Array.isArray(i.data)?i.data:[]:[],m=new Set(p),f=t.display_name||"there";e.innerHTML=`
    <div class="fade-in">
      <!-- Greeting -->
      <section class="mb-6" aria-label="Greeting">
        <h1 class="text-2xl font-bold text-heading">${ut()}, ${c(f)}</h1>
      ...
      ${r.length===0?`
        ...
        <div class="space-y-3" id="feed-list" role="feed" aria-label="Feed items">
          ${r.map(l=>ue(l,{showBookmark:!0,isBookmarked:m.has(l.id)})).join("")}
        </div>`}
    </div>`}async function xt(e){await d("PATCH","/api/user-preferences",{feed_type:e}),await D()}async function ft(e,t){var s;const n=await d("POST",`/api/bookmarks/${e}/toggle`);if(n.ok){const a=t.querySelector("span"),o=((s=n.data)==null?void 0:s.bookmarked)??!a.textContent.includes("border");a.textContent=o?"bookmark":"bookmark_border",a.classList.toggle("text-accent",o),a.classList.toggle("text-muted",!o),o?a.classList.add("bookmark-pop"):a.classList.remove("bookmark-pop")}}window.switchFeedType=xt;window.toggleBookmark=ft;function C(e){document.getElementById("modal-content").innerHTML=e,document.getElementById("modal-overlay").classList.remove("hidden")}function M(){document.getElementById("modal-overlay").classList.add("hidden")}window.openModal=C;window.closeModal=M;async function gt(e,t){(t==="saved"||t==="collections")&&Pe(t),Ee==="saved"?await bt(e):await ht(e)}async function bt(e){const t=await d("GET","/api/content",null,{limit:50}),n=t.ok?Array.isArray(t.data)?t.data:[]:[];e.innerHTML=`
    <div class="fade-in">
    ...
    </div>`}function vt(e){Pe(e),b("#library/"+e)}function wt(e=""){C(`
    ...
    <div class="space-y-4">
      <div>
        ...
        <input id="m-url" type="url" placeholder="Paste a link..." value="${c(e)}" class="w-full bg-bg border border-border rounded-xl px-4 py-3 text-sm text-heading placeholder-muted/50 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/30" autofocus />
  ...
  `)}async function $t(){var a;const e=document.getElementById("c-title").value.trim();if(!e){u("Title is required",!0);return}const t=document.getElementById("create-col-btn");t.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',t.disabled=!0;const n={title:e,description:document.getElementById("c-desc").value.trim()||null,icon:document.getElementById("c-icon").value.trim()||"folder",theme:document.getElementById("c-theme").value},s=await d("POST","/api/collections",n);s.ok?(M(),u("Collection created!"),b("#collection/"+s.data.id)):(u(((a=s.data)==null?void 0:a.detail)||"Failed to create",!0),t.textContent="Create Collection",t.disabled=!1)}window.switchLibraryTab=vt;window.openSaveContentModal=wt;window.doSaveContent=yt;window.openCreateCollectionModal=kt;window.doCreateCollection=$t;function pe(e,t,n="Confirm",s=!1){return new Promise(a=>{const o=document.getElementById("confirm-overlay");document.getElementById("confirm-content").innerHTML=`
    ...
    <div class="slide-in-right">
      ...
      <div class="flex items-center gap-2 flex-wrap mb-5">
        ${L(a.platform,"blue")}
        ${L(a.content_type,"purple")}
        ${L(a.ai_category,"emerald")}
    ...
    </div>`}function _t(e,t){return W==="summary"?e.ai_summary?`<div class="bg-surface rounded-2xl p-5 shadow-card border border-border">
    ...
    </div>`}function Ct(e,t){Le(e),Y(document.getElementById("page"),t)}function St(e){C(`
  ...
  `)}async function Tt(e){var s;const t=document.getElementById("ai-btn");t.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div> Processing...',t.disabled=!0;const n=await d("POST","/api/ai/process-content",{content_id:e});n.ok?(u("AI processing complete!"),Le("summary"),await Y(document.getElementById("page"),e)):(u(((s=n.data)==null?void 0:s.detail)||"AI processing failed",!0),t.innerHTML='<span class="material-icons-round text-lg">auto_awesome</span> Process with AI',t.disabled=!1)}async function Et(e){const t=await d("GET","/api/collections"),n=t.ok?Array.isArray(t.data)?t.data:[]:[];C(`
  ...
  `)}async function Pt(e,t){var s;const n=await d("POST",`/api/collections/${e}/items`,{content_id:t});n.ok?(M(),u("Added to collection!")):u(((s=n.data)==null?void 0:s.detail)||"Failed to add",!0)}async function Lt(e){const t=await d("GET",`/api/content/${e}`);if(!t.ok)return;const n=t.data;C(`
  ...
  `)}async function At(e){var a;const t=document.getElementById("edit-btn");t.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',t.disabled=!0;const n={title:document.getElementById("e-title").value.trim()||null,description:document.getElementById("e-desc").value.trim()||null,url:document.getElementById("e-url").value.trim()||null},s=await d("PATCH",`/api/content/${e}`,n);s.ok?(M(),u("Content updated!"),await Y(document.getElementById("page"),e)):(u(((a=s.data)==null?void 0:a.detail)||"Failed to update",!0),t.textContent="Save Changes",t.disabled=!1)}async function It(e){var s;if(!await pe("Delete Content","This action cannot be undone. Are you sure?","Delete",!0))return;const n=await d("DELETE",`/api/content/${e}`);n.ok?(u("Deleted!"),b("#library")):u(((s=n.data)==null?void 0:s.detail)||"Failed to delete",!0)}window.switchContentTab=Ct;window.openContentActions=St;window.processWithAI=Tt;window.openAddToCollectionModal=Et;window.addToCollection=Pt;window.openEditContentModal=Lt;window.doEditContent=At;window.deleteContent=It;async function me(e,t){if(!t){b("#library/collections");return}const[n,s]=await Promise.all([d("GET",`/api/collections/${t}`),d("GET",`/api/collections/${t}/items`)]);if(!n.ok){e.innerHTML='<div class="text-center py-16 fade-in"><span class="material-icons-round text-5xl text-muted/30 mb-3">error</span><p class="text-muted">Collection not found</p></div>';return}const a=n.data,o=s.ok?Array.isArray(s.data)?s.data:[]:[];e.innerHTML=`
    <div class="slide-in-right">
      <!-- Header -->
    ...
    </div>`}async function Bt(e){const t=await d("GET","/api/content",null,{limit:50}),n=t.ok?Array.isArray(t.data)?t.data:[]:[];C(`
  ...
  `)}async function Mt(e,t){var s;const n=await d("DELETE",`/api/collections/${e}/items/${t}`);n.ok?(u("Removed from collection"),await me(document.getElementById("page"),e)):u(((s=n.data)==null?void 0:s.detail)||"Failed to remove",!0)}async function jt(e){const t=await d("GET",`/api/collections/${e}`);if(!t.ok)return;const n=t.data;C(`
  ...
  `)}async function Ht(e){var a;const t=document.getElementById("edit-col-btn");t.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',t.disabled=!0;const n={title:document.getElementById("ec-title").value.trim()||null,description:document.getElementById("ec-desc").value.trim()||null,is_shared:document.getElementById("ec-shared").checked},s=await d("PATCH",`/api/collections/${e}`,n);s.ok?(M(),u("Collection updated!"),await me(document.getElementById("page"),e)):(u(((a=s.data)==null?void 0:a.detail)||"Failed to update",!0),t.textContent="Save Changes",t.disabled=!1)}async function Gt(e){var s;if(!await pe("Delete Collection","This will remove the collection but not its content. Continue?","Delete",!0))return;const n=await d("DELETE",`/api/collections/${e}`);n.ok?(u("Deleted!"),b("#library/collections")):u(((s=n.data)==null?void 0:s.detail)||"Failed to delete",!0)}window.openAddContentToCollectionModal=Bt;window.removeFromCollection=Mt;window.openEditCollectionModal=jt;window.doEditCollection=Ht;window.deleteCollection=Gt;async function O(e){const[t,n]=await Promise.all([d("GET","/api/goals",null,{status:E}),E==="active"?d("GET","/api/goals/suggestions",null,{status:"pending"}):Promise.resolve({ok:!0,data:[]})]),s=t.ok?Array.isArray(t.data)?t.data:[]:[],a=n.ok?Array.isArray(n.data)?n.data:[]:[],o=s.filter(l=>!l.parent_goal_id),i={};s.filter(l=>l.parent_goal_id).forEach(l=>{i[l.parent_goal_id]||(i[l.parent_goal_id]=[]),i[l.parent_goal_id].push(l)});const r=s.flatMap(l=>l.steps||[]),p=r.length,m=r.filter(l=>l.is_completed).length,f=p>0?Math.round(m/p*100):0;e.innerHTML=`
    <div class="fade-in">
      ...
      <div class="flex items-center justify-between mb-5">
        <div class="flex items-center gap-4">
          <div class="relative">
            ${Be(f,52,4)}
            <span class="absolute inset-0 flex items-center justify-center text-xs font-bold text-heading">${f}%</span>
          </div>
          <div>
      ...
      ${a.length>0?`
        ...
        ${P?`<div class="space-y-3 mb-4">${a.map(Ot).join("")}</div>`:""}
      `:""}
    ...
    </div>`}function Rt(e,t=[]){const n=Math.round((e.confidence||0)*100),s=(e.evidence_content_ids||[]).length,a=t.length>0,o=e.steps||[],i=o.filter(l=>l.is_completed).length,r=o.length,p=r>0?Math.round(i/r*100):0,f={active:"border-l-accent",completed:"border-l-success",dismissed:"border-l-muted"}[e.status]||"border-l-accent";return`
    <article onclick="navigate('#goal-detail/${e.id}')" class="bg-surface rounded-2xl p-4 shadow-card hover:shadow-elevated transition-all duration-200 cursor-pointer active:scale-[0.97] border-l-4 ${f}">
    ...
    </div>`}function Dt(){nt(!P),O(document.getElementById("page"))}function Ft(){C(`
  ...
  `)}async function Ut(e){var s,a;const t=document.getElementById("accept-"+e);t&&(t.innerHTML='<div class="spinner" style="width:14px;height:14px;border-width:2px;"></div>',t.disabled=!0);const n=await d("POST",`/api/goals/suggestions/${e}/accept`);n.ok?(u(((s=n.data)==null?void 0:s.message)||"Goals merged!"),O(document.getElementById("page"))):(u(((a=n.data)==null?void 0:a.detail)||"Failed to merge",!0),t&&(t.textContent="Accept",t.disabled=!1))}async function zt(e){var s;const t=document.getElementById("dismiss-"+e);t&&(t.innerHTML='<div class="spinner" style="width:14px;height:14px;border-width:2px;"></div>',t.disabled=!0);const n=await d("POST",`/api/goals/suggestions/${e}/dismiss`);n.ok?(u("Suggestion dismissed"),O(document.getElementById("page"))):(u(((s=n.data)==null?void 0:s.detail)||"Failed to dismiss",!0),t&&(t.textContent="Dismiss",t.disabled=!1))}async function Nt(){var t,n;u("Starting consolidation...");const e=await d("POST","/api/goals/consolidate");e.ok?u(((t=e.data)==null?void 0:t.message)||"Consolidation started!"):u(((n=e.data)==null?void 0:n.detail)||"Consolidation failed",!0)}async function qt(){var t,n;u("Reanalyzing goals...");const e=await d("POST","/api/goals/reanalyze");e.ok?u(((t=e.data)==null?void 0:t.message)||"Reanalysis started!"):u(((n=e.data)==null?void 0:n.detail)||"Reanalysis failed",!0)}function Kt(e){tt(e),O(document.getElementById("page"))}window.setGoalsFilterAndRender=Kt;window.toggleSuggestions=Dt;window.openGoalsMenu=Ft;window.acceptSuggestion=Ut;window.dismissSuggestion=zt;window.triggerConsolidate=Nt;window.reanalyzeGoals=qt;async function Q(e,t){if(!t){b("#goals");return}const n=await d("GET",`/api/goals/${t}`);if(!n.ok){e.innerHTML='<div class="text-center py-16 fade-in"><span class="material-icons-round text-5xl text-muted/30 mb-3">error</span><p class="text-muted">Goal not found</p></div>';return}const s=n.data,a=s.steps||[],o=a.filter(g=>g.is_completed),i=a.filter(g=>!g.is_completed),r=o.length,p=a.length,m=p>0?Math.round(r/p*100):0,f=Math.round((s.confidence||0)*100),l=(s.evidence_content_ids||[]).length,x=s.children||[],y=x.length>0,h=!!s.parent_goal_id,k=y?"#a855f7":"#6366f1";e.innerHTML=`
    <div class="slide-in-right">
      <!-- Header -->
      <div class="flex items-center gap-3 mb-4">
      ...
      <section class="bg-surface rounded-2xl p-5 mb-4 shadow-card border border-border">
        <div class="flex items-center gap-4 mb-4">
          ...
          <div class="flex-1 min-w-0">
            ...
            <div class="flex items-center gap-2 mt-1 flex-wrap">
              ${L(s.category,"emerald")}
              ${L(s.status,s.status==="active"?"indigo":s.status==="completed"?"green":"gray")}
        ...
        <div class="flex items-center gap-4 mt-4 text-xs text-muted">
          <span class="flex items-center gap-1"><span class="material-icons-round text-sm">trending_up</span>${f}% confidence</span>
      ...
      <section class="mb-4" aria-label="Sub-goals">
        ...
        <div class="flex gap-3 overflow-x-auto no-scrollbar pb-1">
          ${x.map(g=>{const ee=Math.round((g.confidence||0)*100),A=g.status||"active",j=A==="completed"?"check_circle":A==="dismissed"?"do_not_disturb_on":"flag",F=A==="completed"?"text-success":A==="dismissed"?"text-muted":"text-accent";return`
            <article onclick="navigate('#goal-detail/${g.id}')" class="flex-shrink-0 w-44 bg-surface rounded-xl p-3.5 shadow-card border border-border hover:shadow-elevated transition-all cursor-pointer active:scale-[0.97]">
              ...
              <h4 class="font-semibold text-heading text-xs leading-snug line-clamp-2">${c(g.title)}</h4>
            </article>`}).join("")}
        </div>
      </section>`:""}
    ...
    </div>`}function Wt(e){st(!J),Q(document.getElementById("page"),e)}async function Jt(e,t,n){var a;const s=await d("PATCH",`/api/goals/${e}/steps/${t}`,{is_completed:n});s.ok?await Q(document.getElementById("page"),e):u(((a=s.data)==null?void 0:a.detail)||"Failed to update step",!0)}async function Zt(e,t){var s;const n=await d("PATCH",`/api/goals/${e}`,{status:t});n.ok?(u(`Goal ${t==="completed"?"completed":t==="dismissed"?"dismissed":"reactivated"}!`),await Q(document.getElementById("page"),e)):u(((s=n.data)==null?void 0:s.detail)||"Failed to update goal",!0)}async function Vt(e){var s;if(!await pe("Delete Goal","This will delete the goal and all its steps. Continue?","Delete",!0))return;const n=await d("DELETE",`/api/goals/${e}`);n.ok?(u("Goal deleted"),b("#goals")):u(((s=n.data)==null?void 0:s.detail)||"Failed to delete",!0)}window.toggleCompletedSteps=Wt;window.toggleGoalStep=Jt;window.updateGoalStatus=Zt;window.deleteGoal=Vt;function Me(){try{return JSON.parse(localStorage.getItem("zuno_searches")||"[]")}catch{return[]}}function Yt(e){const t=Me().filter(n=>n!==e);t.unshift(e),localStorage.setItem("zuno_searches",JSON.stringify(t.slice(0,5)))}async function Qt(e){const t=await d("GET","/api/tags/popular"),n=t.ok?Array.isArray(t.data)?t.data:[]:[],s=Me();e.innerHTML=`
    <div class="fade-in">
      <!-- Search Input -->
  ...
  `)}async function nn(){var t;u("Reindexing...");const e=await d("POST","/api/knowledge/reindex",{});e.ok?u(`Reindexed: ${e.data.content_processed} items, ${e.data.chunks_created} chunks`):u(((t=e.data)==null?void 0:t.detail)||"Reindex failed",!0)}function sn(){ot(),Ge(document.getElementById("page"))}window.askSuggested=en;window.doAsk=Re;window.openKnowledgeSettings=tn;window.doReindex=nn;window.clearKnowledgeAndRender=sn;async function xe(e){var p;const[t,n,s]=await Promise.all([d("GET","/api/profile"),d("GET","/api/user-preferences"),d("GET","/api/admin/me")]),a=t.ok?t.data:{},o=n.ok?n.data:{},i=Ue(),r=s.ok&&((p=s.data)==null?void 0:p.admin)===!0;e.innerHTML=`
    <div class="fade-in">
      <!-- Avatar Hero -->
        ...
        <div>
          ...
          <div class="flex gap-2">
            ${["light","dark","system"].map(m=>`
              <button onclick="applyTheme('${m}');renderProfile(document.getElementById('page'))" class="flex-1 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 flex items-center justify-center gap-1.5 ${i===m?"bg-accent text-white shadow-sm":"bg-bg border border-border text-muted hover:text-heading"} active:scale-[0.97]">
    ...
    </div>`}async function an(){var s;const e=document.getElementById("profile-btn");e.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',e.disabled=!0;const t={display_name:document.getElementById("p-name").value.trim()||null,avatar_url:document.getElementById("p-avatar").value.trim()||null},n=await d("PATCH","/api/profile",t);n.ok?(le(null),u("Profile updated!")):u(((s=n.data)==null?void 0:s.detail)||"Failed to update",!0),e.textContent="Update Profile",e.disabled=!1}async function on(e){await d("PATCH","/api/user-preferences",{feed_type:e}),u("Feed preference updated!"),await xe(document.getElementById("page"))}window.renderProfile=xe;window.doUpdateProfile=an;window.updateFeedPref=on;async function Oe(e){var n;const t=await d("GET","/api/admin/me");if(!t.ok||!((n=t.data)!=null&&n.admin)){b("#profile");return}e.innerHTML=`
    <div class="fade-in">
      <div class="flex items-center gap-3 mb-5">
    ...
    </div>`,document.getElementById("topnav").classList.add("hidden"),document.getElementById("bottomnav").classList.add("hidden");return}if(t==="feed"){b("#home");return}if(t==="content"){b("#library");return}if(t==="collections"){b("#library");return}const s=t==="auth";document.getElementById("topnav").classList.toggle("hidden",s),document.getElementById("topnav").classList.toggle("flex",!s),document.getElementById("bottomnav").classList.toggle("hidden",s),document.getElementById("fab-btn").classList.toggle("hidden",t!=="library");const a={home:"home",library:"library","content-detail":"library",collection:"library",goals:"goals","goal-detail":"goals",knowledge:"knowledge",profile:"profile",admin:"profile"};document.querySelectorAll(".nav-btn").forEach(p=>{const m=p.dataset.tab===a[t];p.classList.toggle("text-accent",m),p.classList.toggle("text-muted",!m)});const o=document.getElementById("page"),i=mn(t);rt(t);const r={home:K(3),library:K(3),goals:K(3),"content-detail":ne(),"goal-detail":ne(),collection:ne(),admin:we()};o.innerHTML=`<div class="${i}">${r[t]||we()}</div>`;try{switch(t){case"auth":Ae(o);break;case"home":await mt(o);break;case"library":await gt(o,n);try{const p=sessionStorage.getItem("zuno_pending_share");p&&(sessionStorage.removeItem("zuno_pending_share"),typeof openSaveContentModal=="function"&&openSaveContentModal(p))}catch{}break;case"content-detail":await Y(o,n);break;case"collection":await me(o,n);break;case"goals":await O(o);break;case"goal-detail":await Q(o,n);break;case"search":await Qt(o);break;case"knowledge":await Ge(o);break;case"profile":await xe(o);break;case"admin":await Oe(o);break;default:b("#home")}}catch(p){o.innerHTML=`<div class="flex flex-col items-center justify-center py-16 text-center fade-in">
    ...
    </div>`}}window.router=D;/*! Capacitor: https://capacitorjs.com/ - MIT License */var B;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(B||(B={}));class se extends Error{constructor(t,n,s){super(t),this.message=t,this.code=n,this.data=s}}const xn=e=>{var t,n;return e!=null&&e.androidBridge?"android":!((n=(t=e==null?void 0:e.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||n===void 0)&&n.bridge?"ios":"web"},fn=e=>{const t=e.CapacitorCustomPlatform||null,n=e.Capacitor||{},s=n.Plugins=n.Plugins||{},a=()=>t!==null?t.name:xn(e),o=()=>a()!=="web",i=l=>{const x=m.get(l);return!!(x!=null&&x.platforms.has(a())||r(l))},r=l=>{var x;return(x=n.PluginHeaders)===null||x===void 0?void 0:x.find(y=>y.name===l)},p=l=>e.console.error(l),m=new Map,f=(l,x={})=>{const y=m.get(l);if(y)return console.warn(`Capacitor plugin "${l}" already registered. Cannot register plugins twice.`),y.proxy;const h=a(),k=r(l);let g;const ee=async()=>(!g&&h in x?g=typeof x[h]=="function"?g=await x[h]():g=x[h]:t!==null&&!g&&"web"in x&&(g=typeof x.web=="function"?g=await x.web():g=x.web),g),A=(v,w)=>{var _,S;if(k){const T=k==null?void 0:k.methods.find($=>w===$.name);if(T)return T.rtype==="promise"?$=>n.nativePromise(l,w.toString(),$):($,U)=>n.nativeCallback(l,w.toString(),$,U);if(v)return(_=v[w])===null||_===void 0?void 0:_.bind(v)}else{if(v)return(S=v[w])===null||S===void 0?void 0:S.bind(v);throw new se(`"${l}" plugin is not implemented on ${h}`,B.Unimplemented)}},j=v=>{let w;const _=(...S)=>{const T=ee().then($=>{const U=A($,v);if(U){const z=U(...S);return w=z==null?void 0:z.remove,z}else throw new se(`"${l}.${v}()" is not implemented on ${h}`,B.Unimplemented)});return v==="addListener"&&(T.remove=async()=>w()),T};return _.toString=()=>`${v.toString()}() { [capacitor code] }`,Object.defineProperty(_,"name",{value:v,writable:!1,configurable:!1}),_},F=j("addListener"),ge=j("removeListener"),De=(v,w)=>{const _=F({eventName:v},w),S=async()=>{const $=await _;ge({eventName:v,callbackId:$},w)},T=new Promise($=>_.then(()=>$({remove:S})));return T.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await S()},T},te=new Proxy({},{get(v,w){switch(w){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return k?De:F;case"removeListener":return ge;default:return j(w)}}});return s[l]=te,m.set(l,{name:l,proxy:te,platforms:new Set([...Object.keys(x),...k?[h]:[]])}),te};return n.convertFileSrc||(n.convertFileSrc=l=>l),n.getPlatform=a,n.handleError=p,n.isNativePlatform=o,n.isPluginAvailable=i,n.registerPlugin=f,n.Exception=se,n.DEBUG=!!n.DEBUG,n.isLoggingEnabled=!!n.isLoggingEnabled,n},gn=e=>e.Capacitor=fn(e),re=gn(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),X=re.registerPlugin;class fe{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,n){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(n);const o=this.windowListeners[t];o&&!o.registered&&this.addWindowListener(o),s&&this.sendRetainedArgumentsForEvent(t);const i=async()=>this.removeListener(t,n);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,n,s){const a=this.listeners[t];if(!a){if(s){let o=this.retainedEventArguments[t];o||(o=[]),o.push(n),this.retainedEventArguments[t]=o}return}a.forEach(o=>o(n))}hasListeners(t){var n;return!!(!((n=this.listeners[t])===null||n===void 0)&&n.length)}registerWindowListener(t,n){this.windowListeners[n]={registered:!1,windowEventName:t,pluginEventName:n,handler:s=>{this.notifyListeners(n,s)}}}unimplemented(t="not implemented"){return new re.Exception(t,B.Unimplemented)}unavailable(t="not available"){return new re.Exception(t,B.Unavailable)}async removeListener(t,n){const s=this.listeners[t];if(!s)return;const a=s.indexOf(n);this.listeners[t].splice(a,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const n=this.retainedEventArguments[t];n&&(delete this.retainedEventArguments[t],n.forEach(s=>{this.notifyListeners(t,s)}))}}const ke=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),$e=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class bn extends fe{async getCookies(){const t=document.cookie,n={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[a,o]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");a=$e(a).trim(),o=$e(o).trim(),n[a]=o}),n}async setCookie(t){try{const n=ke(t.key),s=ke(t.value),a=`; expires=${(t.expires||"").replace("expires=","")}`,o=(t.path||"/").replace("path=",""),i=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${n}=${s||""}${a}; path=${o}; ${i};`}catch(n){return Promise.reject(n)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(n){return Promise.reject(n)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const n of t)document.cookie=n.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}X("CapacitorCookies",{web:()=>new bn});const hn=async e=>new Promise((t,n)=>{const s=new FileReader;s.onload=()=>{const a=s.result;t(a.indexOf(",")>=0?a.split(",")[1]:a)},s.onerror=a=>n(a),s.readAsDataURL(e)}),vn=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(a=>a.toLocaleLowerCase()).reduce((a,o,i)=>(a[o]=e[t[i]],a),{})},wn=(e,t=!0)=>e?Object.entries(e).reduce((s,a)=>{const[o,i]=a;let r,p;return Array.isArray(i)?(p="",i.forEach(m=>{r=t?encodeURIComponent(m):m,p+=`${o}=${r}&`}),p.slice(0,-1)):(r=t?encodeURIComponent(i):i,p=`${o}=${r}`),`${s}&${p}`},"").substr(1):null,yn=(e,t={})=>{const n=Object.assign({method:e.method||"GET",headers:e.headers},t),a=vn(e.headers)["content-type"]||"";if(typeof e.data=="string")n.body=e.data;else if(a.includes("application/x-www-form-urlencoded")){const o=new URLSearchParams;for(const[i,r]of Object.entries(e.data||{}))o.set(i,r);n.body=o.toString()}else if(a.includes("multipart/form-data")||e.data instanceof FormData){const o=new FormData;if(e.data instanceof FormData)e.data.forEach((r,p)=>{o.append(p,r)});else for(const r of Object.keys(e.data))o.append(r,e.data[r]);n.body=o;const i=new Headers(n.headers);i.delete("content-type"),n.headers=i}else(a.includes("application/json")||typeof e.data=="object")&&(n.body=JSON.stringify(e.data));return n};class kn extends fe{async request(t){const n=yn(t,t.webFetchExtra),s=wn(t.params,t.shouldEncodeUrlParams),a=s?`${t.url}?${s}`:t.url,o=await fetch(a,n),i=o.headers.get("content-type")||"";let{responseType:r="text"}=o.ok?t:{};i.includes("application/json")&&(r="json");let p,m;switch(r){case"arraybuffer":case"blob":m=await o.blob(),p=await hn(m);break;case"json":p=await o.json();break;case"document":case"text":default:p=await o.text()}const f={};return o.headers.forEach((l,x)=>{f[x]=l}),{data:p,headers:f,status:o.status,url:o.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}X("CapacitorHttp",{web:()=>new kn});var _e;(function(e){e.Dark="DARK",e.Light="LIGHT",e.Default="DEFAULT"})(_e||(_e={}));var Ce;(function(e){e.StatusBar="StatusBar",e.NavigationBar="NavigationBar"})(Ce||(Ce={}));class $n extends fe{async setStyle(){this.unavailable("not available for web")}async setAnimation(){this.unavailable("not available for web")}async show(){this.unavailable("not available for web")}async hide(){this.unavailable("not available for web")}}X("SystemBars",{web:()=>new $n});const _n=X("App",{web:()=>V(()=>import("./web-XUUozi4O.js"),[]).then(e=>new e.AppWeb)}),Cn=/https?:\/\/[^\s)<>]+/i;async function Sn(e){if(!e||!e.content)return;if(!localStorage.getItem("zuno_token")){u("Please log in to save shared content",!0);return}try{e.type==="text"?await Tn(e.content):e.type==="image"&&await En(e.content,e.mimeType||"image/jpeg")}catch(n){console.error("[ShareHandler]",n),u("Failed to save shared content",!0)}}async function Tn(e){var n,s;const t=e.match(Cn);if(t){const a=t[0],o=await d("POST","/api/content",{url:a});o.ok?(u("Saved to Zuno!"),d("POST","/api/ai/process-content",{content_id:o.data.id})):u(((n=o.data)==null?void 0:n.detail)||"Failed to save link",!0)}else{const a=e.length>80?e.slice(0,77)+"...":e,o=await d("POST","/api/content/text",{title:a,source_text:e});o.ok?u("Note saved to Zuno!"):u(((s=o.data)==null?void 0:s.detail)||"Failed to save note",!0)}}async function En(e,t){const n=atob(e),s=new Uint8Array(n.length);for(let x=0;x<n.length;x++)s[x]=n.charCodeAt(x);const a=new Blob([s],{type:t}),o=t.split("/")[1]||"jpg",i=`shared_${Date.now()}.${o}`,r=new FormData;r.append("file",a,i);const p=window.ZUNO_API_BASE||(window.location.hostname==="localhost"&&!window.location.port?"http://10.0.2.2:8000":window.location.origin),m=localStorage.getItem("zuno_token"),f=await fetch(`${p}/api/v1/content/upload`,{method:"POST",headers:m?{Authorization:`Bearer ${m}`}:{},body:r}),l=await f.json().catch(()=>({}));f.ok?(u("Image saved to Zuno!"),l.id&&d("POST","/api/ai/process-content",{content_id:l.id})):u((l==null?void 0:l.detail)||"Failed to save image",!0)}window.handleSharedContent=Sn;Fe();Z()&&_n.addListener("appUrlOpen",async e=>{e.url&&e.url.includes("access_token")&&await ce(e.url)&&D()});function Pn(e){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}window.addEventListener("hashchange",D);Pn(async()=>{const t=new URLSearchParams(window.location.search).get("share");if(t){try{sessionStorage.setItem("zuno_pending_share",t)}catch{}const s=new URL(window.location.href);s.searchParams.delete("share"),window.history.replaceState({},"",s.pathname+s.search+(s.hash||""))}await ce(),await D(),Te();const n=2e3;if(typeof hideSplash=="function"){const s=typeof window._splashStart=="number"?Date.now()-window._splashStart:0,a=Math.max(0,n-s);setTimeout(hideSplash,a)}});export{fe as W,V as _,X as r};
