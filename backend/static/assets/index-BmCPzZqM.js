const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DVl4B_Mv.js","assets/index-D-eiEXcv.js","assets/index-BV6hRNtX.js"])))=>i.map(i=>d[i]);
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();const he="modulepreload",ve=function(e){return"/static/"+e},Q={},j=function(t,n,s){let a=Promise.resolve();if(n&&n.length>0){let i=function(p){return Promise.all(p.map(x=>Promise.resolve(x).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),m=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));a=i(n.map(p=>{if(p=ve(p),p in Q)return;Q[p]=!0;const x=p.endsWith(".css"),u=x?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${u}`))return;const g=document.createElement("link");if(g.rel=x?"stylesheet":he,x||(g.as="script"),g.crossOrigin="",g.href=p,m&&g.setAttribute("nonce",m),document.head.appendChild(g),x)return new Promise((y,h)=>{g.addEventListener("load",y),g.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${p}`)))})}))}function o(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return a.then(i=>{for(const r of i||[])r.status==="rejected"&&o(r.reason);return t().catch(o)})};function ye(){const e=localStorage.getItem("zuno_theme")||"system";U(e),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{(localStorage.getItem("zuno_theme")||"system")==="system"&&U("system")})}function U(e){localStorage.setItem("zuno_theme",e);const t=e==="dark"||e==="system"&&window.matchMedia("(prefers-color-scheme: dark)").matches;document.documentElement.classList.toggle("dark",t)}function we(){return localStorage.getItem("zuno_theme")||"system"}window.applyTheme=U;const ne="https://orpdwhqgcthwjnbirizx.supabase.co",ke="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ycGR3aHFnY3Rod2puYmlyaXp4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzA3MjUxMjAsImV4cCI6MjA4NjMwMTEyMH0.4RMhxpB6tTSDEKQfubST_TzPhsvx2Z1HT2juHZDD7qM",$e="com.zuno.app",_e=`${$e}://callback`;function R(){return!!(window.Capacitor&&window.Capacitor.isNativePlatform&&window.Capacitor.isNativePlatform())}function Ce(){return R()?_e:window.location.origin+window.location.pathname}function b(e){window.location.hash=e}function Se(){const t=(window.location.hash||"#auth").replace("#","").split("/");return{page:t[0],id:t[1]||null}}window.navigate=b;const Te=window.ZUNO_API_BASE||(window.location.hostname==="localhost"&&!window.location.port?"http://10.0.2.2:8000":window.location.origin);let S=null;async function X(e,t,n,s){const a=localStorage.getItem("zuno_token"),o={};a&&(o.Authorization=`Bearer ${a}`);let i=`${Te}${t}`;if(s){const u=new URLSearchParams;Object.entries(s).forEach(([y,h])=>{h!==""&&h!=null&&u.append(y,h)});const g=u.toString();g&&(i+="?"+g)}const r={method:e,headers:o};n&&["POST","PATCH","PUT","DELETE"].includes(e)&&(o["Content-Type"]="application/json",r.body=JSON.stringify(n));const m=await fetch(i,r),p=await m.text();let x;try{x=JSON.parse(p)}catch{x=p}return{ok:m.ok,status:m.status,data:x}}async function d(e,t,n=null,s=null){try{let a=await X(e,t,n,s);return a.status===401&&(localStorage.getItem("zuno_refresh_token")&&await Ee()&&(a=await X(e,t,n,s)),a.status===401&&(localStorage.removeItem("zuno_token"),localStorage.removeItem("zuno_refresh_token"),window.location.hash!=="#auth"&&(window.location.hash="#auth"))),a}catch(a){return{ok:!1,status:0,data:{error:a.message}}}}async function Ee(){return S||(S=(async()=>{try{const{refreshAccessToken:e}=await j(async()=>{const{refreshAccessToken:t}=await Promise.resolve().then(()=>Oe);return{refreshAccessToken:t}},void 0);return await e()}catch{return!1}finally{S=null}})(),S)}let T=null;function q(e){T=e}async function Ae(e=!1){if(T&&!e)return T;const t=await d("GET","/api/profile");return t.ok&&(T=t.data),T||{}}let se="saved";function ae(e){se=e}let G="summary";function oe(e){G=e}let w="active";function Ie(e){w=e}let k=!1;function Pe(e){k=e}let H=!1;function Le(e){H=e}let _="fts";function Be(e){_=e}let E=[];function ee(e){E.push(e)}function Me(){E=[]}const Ge=["What topics appear most in my saved content?","Summarize my most recent saves","What are the key takeaways from my articles?","How are my saved items connected?"];let B=null;function He(e){B=e}function M(e=3){return Array(e).fill(0).map(()=>`
    ...
    </div>`}function je(){return'<div class="flex justify-center py-12"><div class="spinner"></div></div>'}function c(e,t=!1){const n=document.getElementById("toast");n.querySelector(".toast-msg").textContent=e;const s=n.querySelector(".toast-icon");s.textContent=t?"error_outline":"check_circle",s.className=`toast-icon material-icons-round text-lg ${t?"text-danger":"text-success"}`,n.classList.remove("hidden"),clearTimeout(n._t),n._t=setTimeout(()=>n.classList.add("hidden"),3e3)}window.toast=c;function ie(e){e.innerHTML=`
  ...
  </svg>`}async function ze(e){const t=await Ae(),n=await d("GET","/api/user-preferences"),s=n.ok?n.data.feed_type:"usersaved",a=s==="suggestedcontent"?"/api/suggested-feed":"/api/feed",[o,i]=await Promise.all([d("GET",a,null,{limit:30}),d("GET","/api/bookmarks")]),r=o.ok?Array.isArray(o.data)?o.data:o.data.items||[]:[],m=i.ok?Array.isArray(i.data)?i.data:[]:[],p=new Set(m),x=t.display_name||"there";e.innerHTML=`
    <div class="fade-in">
      <!-- Greeting -->
    ...
    </div>`}function Ye(e){ae(e),b("#library/"+e)}function Ve(){v(`
  ...
  `)}async function We(){var s;const e=document.getElementById("m-url").value.trim();if(!e){c("URL is required",!0);return}const t=document.getElementById("save-content-btn");t.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',t.disabled=!0;const n=await d("POST","/api/content",{url:e});n.ok?(C(),c("Content saved!"),b("#content-detail/"+n.data.id)):(c(((s=n.data)==null?void 0:s.detail)||"Failed to save",!0),t.textContent="Save Content",t.disabled=!1)}function Qe(){v(`
  ...
  `)}async function Xe(){var a;const e=document.getElementById("c-title").value.trim();if(!e){c("Title is required",!0);return}const t=document.getElementById("create-col-btn");t.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',t.disabled=!0;const n={title:e,description:document.getElementById("c-desc").value.trim()||null,icon:document.getElementById("c-icon").value.trim()||"folder",theme:document.getElementById("c-theme").value},s=await d("POST","/api/collections",n);s.ok?(C(),c("Collection created!"),b("#collection/"+s.data.id)):(c(((a=s.data)==null?void 0:a.detail)||"Failed to create",!0),t.textContent="Create Collection",t.disabled=!1)}window.switchLibraryTab=Ye;window.openSaveContentModal=Ve;window.doSaveContent=We;window.openCreateCollectionModal=Qe;window.doCreateCollection=Xe;function Y(e,t,n="Confirm",s=!1){return new Promise(a=>{const o=document.getElementById("confirm-overlay");document.getElementById("confirm-content").innerHTML=`
  ...
  `)}async function st(e){var s;const t=document.getElementById("ai-btn");t.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div> Processing...',t.disabled=!0;const n=await d("POST","/api/ai/process-content",{content_id:e});n.ok?(c("AI processing complete!"),oe("summary"),await F(document.getElementById("page"),e)):(c(((s=n.data)==null?void 0:s.detail)||"AI processing failed",!0),t.innerHTML='<span class="material-icons-round text-lg">auto_awesome</span> Process with AI',t.disabled=!1)}async function at(e){const t=await d("GET","/api/collections"),n=t.ok?Array.isArray(t.data)?t.data:[]:[];v(`
  ...
  `)}async function ot(e,t){var s;const n=await d("POST",`/api/collections/${e}/items`,{content_id:t});n.ok?(C(),c("Added to collection!")):c(((s=n.data)==null?void 0:s.detail)||"Failed to add",!0)}async function it(e){const t=await d("GET",`/api/content/${e}`);if(!t.ok)return;const n=t.data;v(`
  ...
  `)}async function lt(e){var a;const t=document.getElementById("edit-btn");t.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',t.disabled=!0;const n={title:document.getElementById("e-title").value.trim()||null,description:document.getElementById("e-desc").value.trim()||null,url:document.getElementById("e-url").value.trim()||null},s=await d("PATCH",`/api/content/${e}`,n);s.ok?(C(),c("Content updated!"),await F(document.getElementById("page"),e)):(c(((a=s.data)==null?void 0:a.detail)||"Failed to update",!0),t.textContent="Save Changes",t.disabled=!1)}async function rt(e){var s;if(!await Y("Delete Content","This action cannot be undone. Are you sure?","Delete",!0))return;const n=await d("DELETE",`/api/content/${e}`);n.ok?(c("Deleted!"),b("#library")):c(((s=n.data)==null?void 0:s.detail)||"Failed to delete",!0)}window.switchContentTab=tt;window.openContentActions=nt;window.processWithAI=st;window.openAddToCollectionModal=at;window.addToCollection=ot;window.openEditContentModal=it;window.doEditContent=lt;window.deleteContent=rt;async function V(e,t){if(!t){b("#library/collections");return}const[n,s]=await Promise.all([d("GET",`/api/collections/${t}`),d("GET",`/api/collections/${t}/items`)]);if(!n.ok){e.innerHTML='<div class="text-center py-16 fade-in"><span class="material-icons-round text-5xl text-muted/30 mb-3">error</span><p class="text-muted">Collection not found</p></div>';return}const a=n.data,o=s.ok?Array.isArray(s.data)?s.data:[]:[];e.innerHTML=`
    <div class="slide-in-right">
      <!-- Header -->
    ...
    </div>`}async function ct(e){const t=await d("GET","/api/content",null,{limit:50}),n=t.ok?Array.isArray(t.data)?t.data:[]:[];v(`
  ...
  `)}async function dt(e,t){var s;const n=await d("DELETE",`/api/collections/${e}/items/${t}`);n.ok?(c("Removed from collection"),await V(document.getElementById("page"),e)):c(((s=n.data)==null?void 0:s.detail)||"Failed to remove",!0)}async function ut(e){const t=await d("GET",`/api/collections/${e}`);if(!t.ok)return;const n=t.data;v(`
  ...
  `)}async function pt(e){var a;const t=document.getElementById("edit-col-btn");t.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',t.disabled=!0;const n={title:document.getElementById("ec-title").value.trim()||null,description:document.getElementById("ec-desc").value.trim()||null,is_shared:document.getElementById("ec-shared").checked},s=await d("PATCH",`/api/collections/${e}`,n);s.ok?(C(),c("Collection updated!"),await V(document.getElementById("page"),e)):(c(((a=s.data)==null?void 0:a.detail)||"Failed to update",!0),t.textContent="Save Changes",t.disabled=!1)}async function mt(e){var s;if(!await Y("Delete Collection","This will remove the collection but not its content. Continue?","Delete",!0))return;const n=await d("DELETE",`/api/collections/${e}`);n.ok?(c("Deleted!"),b("#library/collections")):c(((s=n.data)==null?void 0:s.detail)||"Failed to delete",!0)}window.openAddContentToCollectionModal=ct;window.removeFromCollection=dt;window.openEditCollectionModal=ut;window.doEditCollection=pt;window.deleteCollection=mt;async function A(e){const[t,n]=await Promise.all([d("GET","/api/goals",null,{status:w}),w==="active"?d("GET","/api/goals/suggestions",null,{status:"pending"}):Promise.resolve({ok:!0,data:[]})]),s=t.ok?Array.isArray(t.data)?t.data:[]:[],a=n.ok?Array.isArray(n.data)?n.data:[]:[],o=s.filter(u=>!u.parent_goal_id),i={};s.filter(u=>u.parent_goal_id).forEach(u=>{i[u.parent_goal_id]||(i[u.parent_goal_id]=[]),i[u.parent_goal_id].push(u)});const r=s.flatMap(u=>u.steps||[]),m=r.length,p=r.filter(u=>u.is_completed).length,x=m>0?Math.round(p/m*100):0;e.innerHTML=`
    <div class="fade-in">
    ...
    </div>`}function xt(e,t=[]){const n=Math.round((e.confidence||0)*100),s=(e.evidence_content_ids||[]).length,a=t.length>0,o=e.steps||[],i=o.filter(u=>u.is_completed).length,r=o.length,m=r>0?Math.round(i/r*100):0,x={active:"border-l-accent",completed:"border-l-success",dismissed:"border-l-muted"}[e.status]||"border-l-accent";return`
    ...
    </div>`}function bt(){Pe(!k),A(document.getElementById("page"))}function ft(){v(`
  ...
  `)}async function ht(e){var s,a;const t=document.getElementById("accept-"+e);t&&(t.innerHTML='<div class="spinner" style="width:14px;height:14px;border-width:2px;"></div>',t.disabled=!0);const n=await d("POST",`/api/goals/suggestions/${e}/accept`);n.ok?(c(((s=n.data)==null?void 0:s.message)||"Goals merged!"),A(document.getElementById("page"))):(c(((a=n.data)==null?void 0:a.detail)||"Failed to merge",!0),t&&(t.textContent="Accept",t.disabled=!1))}async function vt(e){var s;const t=document.getElementById("dismiss-"+e);t&&(t.innerHTML='<div class="spinner" style="width:14px;height:14px;border-width:2px;"></div>',t.disabled=!0);const n=await d("POST",`/api/goals/suggestions/${e}/dismiss`);n.ok?(c("Suggestion dismissed"),A(document.getElementById("page"))):(c(((s=n.data)==null?void 0:s.detail)||"Failed to dismiss",!0),t&&(t.textContent="Dismiss",t.disabled=!1))}async function yt(){var t,n;c("Starting consolidation...");const e=await d("POST","/api/goals/consolidate");e.ok?c(((t=e.data)==null?void 0:t.message)||"Consolidation started!"):c(((n=e.data)==null?void 0:n.detail)||"Consolidation failed",!0)}async function wt(){var t,n;c("Reanalyzing goals...");const e=await d("POST","/api/goals/reanalyze");e.ok?c(((t=e.data)==null?void 0:t.message)||"Reanalysis started!"):c(((n=e.data)==null?void 0:n.detail)||"Reanalysis failed",!0)}function kt(e){Ie(e),A(document.getElementById("page"))}window.setGoalsFilterAndRender=kt;window.toggleSuggestions=bt;window.openGoalsMenu=ft;window.acceptSuggestion=ht;window.dismissSuggestion=vt;window.triggerConsolidate=yt;window.reanalyzeGoals=wt;async function O(e,t){if(!t){b("#goals");return}const n=await d("GET",`/api/goals/${t}`);if(!n.ok){e.innerHTML='<div class="text-center py-16 fade-in"><span class="material-icons-round text-5xl text-muted/30 mb-3">error</span><p class="text-muted">Goal not found</p></div>';return}const s=n.data,a=s.steps||[],o=a.filter(f=>f.is_completed),i=a.filter(f=>!f.is_completed),r=o.length,m=a.length,p=m>0?Math.round(r/m*100):0,x=Math.round((s.confidence||0)*100),u=(s.evidence_content_ids||[]).length,g=s.children||[],y=g.length>0,h=!!s.parent_goal_id,xe=y?"#a855f7":"#6366f1";e.innerHTML=`
    <div class="slide-in-right">
      <!-- Header -->
      <div class="flex items-center gap-3 mb-4">
      ...
      <section class="mb-4" aria-label="Sub-goals">
        ...
        <div class="flex gap-3 overflow-x-auto no-scrollbar pb-1">
          ${g.map(f=>{const ge=Math.round((f.confidence||0)*100),P=f.status||"active",be=P==="completed"?"check_circle":P==="dismissed"?"do_not_disturb_on":"flag",fe=P==="completed"?"text-success":P==="dismissed"?"text-muted":"text-accent";return`
    ...
    </div>`}function $t(e){Le(!H),O(document.getElementById("page"),e)}async function _t(e,t,n){var a;const s=await d("PATCH",`/api/goals/${e}/steps/${t}`,{is_completed:n});s.ok?await O(document.getElementById("page"),e):c(((a=s.data)==null?void 0:a.detail)||"Failed to update step",!0)}async function Ct(e,t){var s;const n=await d("PATCH",`/api/goals/${e}`,{status:t});n.ok?(c(`Goal ${t==="completed"?"completed":t==="dismissed"?"dismissed":"reactivated"}!`),await O(document.getElementById("page"),e)):c(((s=n.data)==null?void 0:s.detail)||"Failed to update goal",!0)}async function St(e){var s;if(!await Y("Delete Goal","This will delete the goal and all its steps. Continue?","Delete",!0))return;const n=await d("DELETE",`/api/goals/${e}`);n.ok?(c("Goal deleted"),b("#goals")):c(((s=n.data)==null?void 0:s.detail)||"Failed to delete",!0)}window.toggleCompletedSteps=$t;window.toggleGoalStep=_t;window.updateGoalStatus=Ct;window.deleteGoal=St;function ce(){try{return JSON.parse(localStorage.getItem("zuno_searches")||"[]")}catch{return[]}}function Tt(e){const t=ce().filter(n=>n!==e);t.unshift(e),localStorage.setItem("zuno_searches",JSON.stringify(t.slice(0,5)))}async function Et(e){const t=await d("GET","/api/tags/popular"),n=t.ok?Array.isArray(t.data)?t.data:[]:[],s=ce();e.innerHTML=`
    <div class="fade-in">
      <!-- Search Input -->
  ...
  `)}async function Lt(){var t;c("Reindexing...");const e=await d("POST","/api/knowledge/reindex",{});e.ok?c(`Reindexed: ${e.data.content_processed} items, ${e.data.chunks_created} chunks`):c(((t=e.data)==null?void 0:t.detail)||"Reindex failed",!0)}function Bt(){Me(),pe(document.getElementById("page"))}window.askSuggested=It;window.doAsk=me;window.openKnowledgeSettings=Pt;window.doReindex=Lt;window.clearKnowledgeAndRender=Bt;async function W(e){const[t,n]=await Promise.all([d("GET","/api/profile"),d("GET","/api/user-preferences")]),s=t.ok?t.data:{},a=n.ok?n.data:{},o=we();e.innerHTML=`
    <div class="fade-in">
      <!-- Avatar Hero -->
    ...
    </div>`}async function Mt(){var s;const e=document.getElementById("profile-btn");e.innerHTML='<div class="spinner" style="width:18px;height:18px;border-width:2px;"></div>',e.disabled=!0;const t={display_name:document.getElementById("p-name").value.trim()||null,avatar_url:document.getElementById("p-avatar").value.trim()||null},n=await d("PATCH","/api/profile",t);n.ok?(q(null),c("Profile updated!")):c(((s=n.data)==null?void 0:s.detail)||"Failed to update",!0),e.textContent="Update Profile",e.disabled=!1}async function Gt(e){await d("PATCH","/api/user-preferences",{feed_type:e}),c("Feed preference updated!"),await W(document.getElementById("page"))}async function Ht(){const e=await d("GET","/api/admin/cache/stats"),t=document.getElementById("cache-stats-result");e.ok?t.innerHTML=`<pre class="text-xs text-muted bg-bg rounded-xl p-3 overflow-x-auto max-h-32">${l(JSON.stringify(e.data,null,2))}</pre>`:t.innerHTML='<p class="text-danger text-xs">Failed to load stats</p>'}async function jt(){var s;const e=document.getElementById("bust-btn");e.innerHTML='<div class="spinner" style="width:14px;height:14px;border-width:2px;"></div>',e.disabled=!0;const t=document.getElementById("cache-pattern").value.trim(),n=await d("POST","/api/admin/cache/bust",null,t?{pattern:t}:null);n.ok?c("Cache busted!"):c(((s=n.data)==null?void 0:s.detail)||"Failed",!0),e.textContent="Bust",e.disabled=!1}async function Rt(){var n;const e=document.getElementById("prompts-btn");e.innerHTML='<div class="spinner" style="width:16px;height:16px;border-width:2px;"></div>',e.disabled=!0;const t=await d("POST","/api/admin/prompts/reload");t.ok?c("Prompts reloaded!"):c(((n=t.data)==null?void 0:n.detail)||"Failed",!0),e.innerHTML='<span class="material-icons-round text-base">refresh</span> Reload Prompts',e.disabled=!1}async function Ft(){var a,o,i;const e=document.getElementById("embed-text").value.trim();if(!e){c("Enter text",!0);return}const t=document.getElementById("embed-btn");t.innerHTML='<div class="spinner" style="width:14px;height:14px;border-width:2px;"></div>',t.disabled=!0;const n=await d("POST","/api/ai/generate-embedding",{text:e}),s=document.getElementById("embed-result");if(n.ok){const r=((a=n.data.embedding)==null?void 0:a.length)||0;s.innerHTML=`<p class="text-success text-xs">Embedding generated (${r} dimensions)</p><pre class="text-xs text-muted bg-bg rounded-lg p-2 mt-1 max-h-24 overflow-y-auto">[${(o=n.data.embedding)==null?void 0:o.slice(0,5).map(m=>m.toFixed(6)).join(", ")}... ]</pre>`}else s.innerHTML=`<p class="text-danger text-xs">${l(((i=n.data)==null?void 0:i.detail)||"Failed")}</p>`;t.textContent="Go",t.disabled=!1}async function Ot(){var s,a;const e=document.getElementById("gen-feed-btn");e.innerHTML='<div class="spinner" style="width:16px;height:16px;border-width:2px;"></div> Generating...',e.disabled=!0;const t=await d("POST","/api/ai/generate-feed"),n=document.getElementById("gen-feed-result");if(t.ok){const o=((s=t.data.items)==null?void 0:s.length)||0;n.innerHTML=`<p class="text-success text-xs">${o} feed items generated</p>`,t.data.message&&(n.innerHTML+=`<p class="text-muted text-xs mt-1">${l(t.data.message)}</p>`)}else n.innerHTML=`<p class="text-danger text-xs">${l(((a=t.data)==null?void 0:a.detail)||"Failed")}</p>`;e.innerHTML='<span class="material-icons-round text-base">auto_awesome</span> Generate Feed',e.disabled=!1}async function Dt(){const e=document.getElementById("health-btn");e.innerHTML='<div class="spinner" style="width:16px;height:16px;border-width:2px;"></div>',e.disabled=!0;const t=await d("GET","/health");document.getElementById("health-result").innerHTML=`<pre class="text-xs ${t.ok?"text-success":"text-danger"} bg-bg rounded-lg p-2 mt-1">${l(JSON.stringify(t.data,null,2))}</pre>`,e.innerHTML='<span class="material-icons-round text-base">monitor_heart</span> Check Health',e.disabled=!1}window.renderProfile=W;window.doUpdateProfile=Mt;window.updateFeedPref=Gt;window.loadCacheStats=Ht;window.doBustCache=jt;window.doReloadPrompts=Rt;window.doGenerateEmbedding=Ft;window.doGenerateFeed=Ot;window.doHealthCheck=Dt;const L=["content-detail","collection","goal-detail"];function Ut(e){return B?L.includes(e)&&!L.includes(B)?"slide-in-right":L.includes(B)&&!L.includes(e)?"slide-in-left":"fade-in":"fade-in"}async function I(){const e=localStorage.getItem("zuno_token"),{page:t,id:n}=Se();if(!e&&t!=="auth"){b("#auth");return}if(e&&t==="auth"){b("#home");return}if(t==="feed"){b("#home");return}if(t==="content"){b("#library");return}if(t==="collections"){b("#library");return}if(t==="admin"){b("#profile");return}const s=t==="auth";document.getElementById("topnav").classList.toggle("hidden",s),document.getElementById("topnav").classList.toggle("flex",!s),document.getElementById("bottomnav").classList.toggle("hidden",s),document.getElementById("fab-btn").classList.toggle("hidden",t!=="library");const a={home:"home",library:"library","content-detail":"library",collection:"library",goals:"goals","goal-detail":"goals",knowledge:"knowledge"};document.querySelectorAll(".nav-btn").forEach(m=>{const p=m.dataset.tab===a[t];m.classList.toggle("text-accent",p),m.classList.toggle("text-muted",!p)});const o=document.getElementById("page"),i=Ut(t);He(t);const r={home:M(3),library:M(3),goals:M(3),"content-detail":D(),"goal-detail":D(),collection:D()};o.innerHTML=`<div class="${i}">${r[t]||je()}</div>`;try{switch(t){case"auth":ie(o);break;case"home":await ze(o);break;case"library":await Ke(o,n);break;case"content-detail":await F(o,n);break;case"collection":await V(o,n);break;case"goals":await A(o);break;case"goal-detail":await O(o,n);break;case"search":await Et(o);break;case"knowledge":await pe(o);break;case"profile":await W(o);break;default:b("#home")}}catch(m){o.innerHTML=`<div class="flex flex-col items-center justify-center py-16 text-center fade-in">
    ...
    </div>`}}window.router=I;const zt=/https?:\/\/[^\s)<>]+/i;async function Nt(e){if(!e||!e.content)return;if(!localStorage.getItem("zuno_token")){c("Please log in to save shared content",!0);return}try{e.type==="text"?await qt(e.content):e.type==="image"&&await Kt(e.content,e.mimeType||"image/jpeg")}catch(n){console.error("[ShareHandler]",n),c("Failed to save shared content",!0)}}async function qt(e){var n,s;const t=e.match(zt);if(t){const a=t[0],o=await d("POST","/api/content",{url:a});o.ok?(c("Saved to Zuno!"),d("POST","/api/ai/process-content",{content_id:o.data.id})):c(((n=o.data)==null?void 0:n.detail)||"Failed to save link",!0)}else{const a=e.length>80?e.slice(0,77)+"...":e,o=await d("POST","/api/content/text",{title:a,source_text:e});o.ok?c("Note saved to Zuno!"):c(((s=o.data)==null?void 0:s.detail)||"Failed to save note",!0)}}async function Kt(e,t){const n=atob(e),s=new Uint8Array(n.length);for(let g=0;g<n.length;g++)s[g]=n.charCodeAt(g);const a=new Blob([s],{type:t}),o=t.split("/")[1]||"jpg",i=`shared_${Date.now()}.${o}`,r=new FormData;r.append("file",a,i);const m=window.ZUNO_API_BASE||(window.location.hostname==="localhost"&&!window.location.port?"http://10.0.2.2:8000":window.location.origin),p=localStorage.getItem("zuno_token"),x=await fetch(`${m}/api/content/upload`,{method:"POST",headers:p?{Authorization:`Bearer ${p}`}:{},body:r}),u=await x.json().catch(()=>({}));x.ok?(c("Image saved to Zuno!"),u.id&&d("POST","/api/ai/process-content",{content_id:u.id})):c((u==null?void 0:u.detail)||"Failed to save image",!0)}window.handleSharedContent=Nt;ye();R()&&j(async()=>{const{App:e}=await import("./index-BV6hRNtX.js");return{App:e}},__vite__mapDeps([2,1])).then(({App:e})=>{e.addListener("appUrlOpen",async t=>{t.url&&t.url.includes("access_token")&&await K(t.url)&&I()})}).catch(()=>{});window.addEventListener("hashchange",I);window.addEventListener("DOMContentLoaded",async()=>{await K(),await I(),typeof hideSplash=="function"&&hideSplash()});export{j as _};
